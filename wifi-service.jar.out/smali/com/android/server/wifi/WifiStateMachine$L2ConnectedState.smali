...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-get27(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get56(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-get41(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiStateMachine$WifiNetworkAgent;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->-get43(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/NetworkInfo;
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->-get42(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/NetworkCapabilities;
    ...
    invoke-static {v7}, Lcom/android/server/wifi/WifiStateMachine;->-get40(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
    ...
    invoke-static {v8}, Lcom/android/server/wifi/WifiStateMachine;->-get44(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/NetworkMisc;
...
.method public exit()V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get36(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->-get36(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get39(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-wrap26(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get90(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiMetrics;
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wifi/WifiQualifiedNetworkSelector;->skipNetworkSelectionForWPS(Z)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v0}, Lcom/android/server/wifi/WifiStateMachine;->-wrap23(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/DhcpResults;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->-wrap39(Lcom/android/server/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-wrap29(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    .line 7053
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->-wrap37(Lcom/android/server/wifi/WifiStateMachine;II)V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get13(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-get21(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-get85(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->-get36(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    .line 7130
    iget v0, v12, Landroid/net/wifi/WifiLinkLayerStats;->rssi_mgmt:I

    if-eqz v0, :cond_7

    .line 7131
    iget v0, v12, Landroid/net/wifi/WifiLinkLayerStats;->beacon_rx:I
    ...
    .line 7144
    .local v7, "autoSwitchToMobileData":Z
    :goto_1
    iget-object v13, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->-get82(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiConfigManager;
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->-get41(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiStateMachine$WifiNetworkAgent;
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->-get90(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiMetrics;

    move-result-object v6

    .line 7145
    invoke-static/range {v0 .. v7}, Lcom/android/server/wifi/WifiScoreReport;->calculateScore(Landroid/net/wifi/WifiInfo;Landroid/net/wifi/WifiConfiguration;Lcom/android/server/wifi/WifiConfigManager;Landroid/net/NetworkAgent;Lcom/android/server/wifi/WifiScoreReport;ILcom/android/server/wifi/WifiMetrics;Z)Lcom/android/server/wifi/WifiScoreReport;

    move-result-object v0

    .line 7144
    iput-object v0, v13, Lcom/android/server/wifi/WifiStateMachine;->mWifiScoreReport:Lcom/android/server/wifi/WifiScoreReport;

    .line 7154
    .end local v7    # "autoSwitchToMobileData":Z
    :cond_9
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->-get85(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->-wrap41(Lcom/android/server/wifi/WifiStateMachine;I)V
    ...
    .restart local v7    # "autoSwitchToMobileData":Z
    goto :goto_1
    ...
    :goto_2
    invoke-static {v1, v0}, Lcom/android/server/wifi/WifiStateMachine;->-set12(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    .line 7177
    :sswitch_f
    new-instance v10, Landroid/net/wifi/RssiPacketCountInfo;

    invoke-direct {v10}, Landroid/net/wifi/RssiPacketCountInfo;-><init>()V

    .line 7178
    .local v10, "info":Landroid/net/wifi/RssiPacketCountInfo;
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    iput v0, v10, Landroid/net/wifi/RssiPacketCountInfo;->rssi:I

    .line 7180
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    invoke-static {v0, v10}, Lcom/android/server/wifi/WifiStateMachine;->-wrap20(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/RssiPacketCountInfo;)V
    ...
    invoke-static {v0, p1, v1, v10}, Lcom/android/server/wifi/WifiStateMachine;->-wrap36(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;ILjava/lang/Object;)V

    goto/16 :goto_0

    .line 7184
    .end local v10    # "info":Landroid/net/wifi/RssiPacketCountInfo;
    :sswitch_10
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->-wrap32(Lcom/android/server/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v9, v1}, Lcom/android/server/wifi/WifiStateMachine;->processRssiThreshold(BI)V

    goto/16 :goto_0

    .line 7221
    .end local v9    # "currRssi":B
    :sswitch_13
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$L2ConnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    invoke-static {v8}, Lcom/android/server/wifi/util/TelephonyUtil;->isSimConfig(Landroid/net/wifi/WifiConfiguration;)Z
