...
.method private readResponseBody(Lorg/apache/commons/httpclient/HttpConnection;)Ljava/io/InputStream;
    ...
    .prologue
    .line 1816
    sget-object v15, Lorg/apache/commons/httpclient/HttpMethodBase;->LOG:Lorg/apache/commons/logging/Log;

    const-string v16, "enter HttpMethodBase.readResponseBody(HttpConnection)"
    ...
    iput-object v15, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->responseBody:[B
    ...
    sget-object v15, Lorg/apache/commons/httpclient/Wire;->CONTENT_WIRE:Lorg/apache/commons/httpclient/Wire;

    invoke-virtual {v15}, Lorg/apache/commons/httpclient/Wire;->enabled()Z
    ...
    .line 1821
    new-instance v9, Lorg/apache/commons/httpclient/WireLogInputStream;

    sget-object v15, Lorg/apache/commons/httpclient/Wire;->CONTENT_WIRE:Lorg/apache/commons/httpclient/Wire;

    invoke-direct {v9, v8, v15}, Lorg/apache/commons/httpclient/WireLogInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/Wire;)V
    ...
    iget-object v15, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->statusLine:Lorg/apache/commons/httpclient/StatusLine;

    invoke-virtual {v15}, Lorg/apache/commons/httpclient/StatusLine;->getStatusCode()I

    move-result v15

    invoke-static {v15}, Lorg/apache/commons/httpclient/HttpMethodBase;->canResponseHaveBody(I)Z

    move-result v2

    .line 1824
    .local v2, "canHaveBody":Z
    const/4 v11, 0x0
    ...
    iget-object v15, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->responseHeaders:Lorg/apache/commons/httpclient/HeaderGroup;

    const-string v16, "Transfer-Encoding"

    invoke-virtual/range {v15 .. v16}, Lorg/apache/commons/httpclient/HeaderGroup;->getFirstHeader(Ljava/lang/String;)Lorg/apache/commons/httpclient/Header;

    move-result-object v14

    .line 1828
    .local v14, "transferEncodingHeader":Lorg/apache/commons/httpclient/Header;
    if-eqz v14, :cond_5

    .line 1830
    invoke-virtual {v14}, Lorg/apache/commons/httpclient/Header;->getValue()Ljava/lang/String;

    move-result-object v13

    .line 1831
    .local v13, "transferEncoding":Ljava/lang/String;
    ...
    invoke-interface/range {v15 .. v16}, Lorg/apache/commons/logging/Log;->warn(Ljava/lang/Object;)V

    .line 1837
    :cond_1
    invoke-virtual {v14}, Lorg/apache/commons/httpclient/Header;->getElements()[Lorg/apache/commons/httpclient/HeaderElement;

    move-result-object v5

    .line 1840
    .local v5, "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    array-length v10, v5
    ...
    invoke-virtual {v15}, Lorg/apache/commons/httpclient/params/HttpConnectionParams;->getSoTimeout()I

    move-result v15

    move-object/from16 v0, p1

    invoke-virtual {v0, v15}, Lorg/apache/commons/httpclient/HttpConnection;->isResponseAvailable(I)Z
    ...
    .line 1844
    new-instance v11, Lorg/apache/commons/httpclient/ChunkedInputStream;

    .end local v11    # "result":Ljava/io/InputStream;
    move-object/from16 v0, p0

    invoke-direct {v11, v8, v0}, Lorg/apache/commons/httpclient/ChunkedInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/HttpMethod;)V

    .line 1880
    .end local v5    # "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    .end local v10    # "len":I
    .end local v13    # "transferEncoding":Ljava/lang/String;
    ...
    .line 1888
    new-instance v11, Lorg/apache/commons/httpclient/AutoCloseInputStream;

    new-instance v15, Lorg/apache/commons/httpclient/HttpMethodBase$1;

    move-object/from16 v0, p0

    invoke-direct {v15, v0}, Lorg/apache/commons/httpclient/HttpMethodBase$1;-><init>(Lorg/apache/commons/httpclient/HttpMethodBase;)V

    invoke-direct {v11, v12, v15}, Lorg/apache/commons/httpclient/AutoCloseInputStream;-><init>(Ljava/io/InputStream;Lorg/apache/commons/httpclient/ResponseConsumedWatcher;)V
    ...
    .line 1846
    .restart local v5    # "encodings":[Lorg/apache/commons/httpclient/HeaderElement;
    .restart local v10    # "len":I
    .restart local v13    # "transferEncoding":Ljava/lang/String;
    :cond_2
    ...
    invoke-virtual/range {v15 .. v16}, Lorg/apache/commons/httpclient/params/HttpMethodParams;->isParameterTrue(Ljava/lang/String;)Z
    ...
    .line 1847
    new-instance v15, Lorg/apache/commons/httpclient/ProtocolException;

    const-string v16, "Chunk-encoded body declared but not sent"

    invoke-direct/range {v15 .. v16}, Lorg/apache/commons/httpclient/ProtocolException;-><init>(Ljava/lang/String;)V
    ...
    const-string v16, "Chunk-encoded body missing"
    ...
    const-string v16, "Response content is not chunk-encoded"
    ...
    invoke-virtual {v0, v15}, Lorg/apache/commons/httpclient/HttpMethodBase;->setConnectionCloseForced(Z)V
    ...
    iget-object v15, v0, Lorg/apache/commons/httpclient/HttpMethodBase;->effectiveVersion:Lorg/apache/commons/httpclient/HttpVersion;

    sget-object v16, Lorg/apache/commons/httpclient/HttpVersion;->HTTP_1_1:Lorg/apache/commons/httpclient/HttpVersion;

    invoke-virtual/range {v15 .. v16}, Lorg/apache/commons/httpclient/HttpVersion;->greaterEquals(Lorg/apache/commons/httpclient/HttpVersion;)Z
    ...
    .line 1864
    .local v4, "connectionHeader":Lorg/apache/commons/httpclient/Header;
    const/4 v3, 0x0

    .line 1865
    .local v3, "connectionDirective":Ljava/lang/String;
    if-eqz v4, :cond_6
    ...
    const-string v16, "Response content length is not known"
    ...
    .line 1873
    .end local v3    # "connectionDirective":Ljava/lang/String;
    .end local v4    # "connectionHeader":Lorg/apache/commons/httpclient/Header;
    :cond_7
    move-object v11, v8
    ...
    .line 1875
    :cond_8
    new-instance v11, Lorg/apache/commons/httpclient/ContentLengthInputStream;

    .end local v11    # "result":Ljava/io/InputStream;
    invoke-direct {v11, v8, v6, v7}, Lorg/apache/commons/httpclient/ContentLengthInputStream;-><init>(Ljava/io/InputStream;J)V

    .restart local v11    # "result":Ljava/io/InputStream;
    goto/16 :goto_0

    .end local v6    # "expectedLength":J
    .end local v11    # "result":Ljava/io/InputStream;
...
.method public getResponseBody(I)[B
    ...
    invoke-virtual {v1, v0, v11, v7}, Ljava/io/InputStream;->read([BII)I
