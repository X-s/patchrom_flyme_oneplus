...
.method private updatePhoneState()V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyToOtherPhoneObject()V
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 463
    .local v23, "newUnknownConnections":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/Connection;>;"
    const/4 v14, 0x0
    ...
    .end local v23    # "newUnknownConnections":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/Connection;>;"
    ...
    .restart local v23    # "newUnknownConnections":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/Connection;>;"
    .restart local v24    # "polledCalls":Ljava/util/List;
    ...
    :try_start_3
    const-string v26, "GsmCallTracker"
    ...
    invoke-direct {v0, v1, v9, v2, v3}, Lcom/android/internal/telephony/gsm/GsmConnection;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/DriverCall;Lcom/android/internal/telephony/gsm/GsmCallTracker;I)V
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmConnection;->onConnectedInOrOut()V
    ...
    const-string v28, "HO Conn state is "
    ...
    const-string v28, "Removing HO conn "
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GSMPhone;->oemMigrateFrom()V
    ...
    invoke-virtual/range {v26 .. v27}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v28, "Phantom call appeared "
    ...
    sget-object v27, Lcom/android/internal/telephony/DriverCall$State;->HOLDING:Lcom/android/internal/telephony/DriverCall$State;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmConnection;->onStartedHolding()V
    ...
    .line 634
    .local v19, "mPhoneNumber":Ljava/lang/String;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GSMPhone;->is_test_card()Z
    ...
    .line 652
    .end local v19    # "mPhoneNumber":Ljava/lang/String;
    .end local v20    # "needAccept":Z
    :cond_17
    :goto_9
    :try_start_5
    move-object/from16 v0, p0
    ...
    .line 636
    .end local v7    # "conn":Lcom/android/internal/telephony/gsm/GsmConnection;
    .restart local v19    # "mPhoneNumber":Ljava/lang/String;
    :cond_19
    const/16 v20, 0x0
    ...
    .line 642
    .restart local v20    # "needAccept":Z
    :catch_1
    move-exception v11
    ...
    const-string v27, "acceptCall failed:"
    ...
    const-string v27, "Notify unknown for "
