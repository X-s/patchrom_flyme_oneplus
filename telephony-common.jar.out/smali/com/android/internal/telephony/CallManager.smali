...
.field private static final EVENT_POLL_CALL_FOR_WARD:I = 0x362
...
.field private static final POLL_DELAY_TIME:I = 0x2710

.field private static final VDBG:Z

.field private static mActiveSub:I

.field private static oldServiceState:[I
...
.field private mHandler:Lcom/android/internal/telephony/CallManager$CallManagerHandler;
...
.method private constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mRegistrantidentifier:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mActiveSubChangeRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mTtyModeReceivedRegistrants:Landroid/os/RegistrantList;
    ...
    sput-object v1, Lcom/android/internal/telephony/CallManager;->oldServiceState:[I

    .line 218
    iput v2, p0, Lcom/android/internal/telephony/CallManager;->counts:I
    ...
    .line 220
    sget-object v1, Lcom/android/internal/telephony/CallManager;->oldServiceState:[I
...
.method static synthetic access$200(Lcom/android/internal/telephony/CallManager;Landroid/os/AsyncResult;)V
    ...
    .prologue
    .line 60
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/CallManager;->processServiceState(Landroid/os/AsyncResult;)V
...
.method static synthetic access$300(Lcom/android/internal/telephony/CallManager;I)V
    ...
    .prologue
    .line 60
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/CallManager;->pollCallForWard(I)V
...
.method private pollCallForWard(I)V
    .locals 4
    .param p1, "phoneId"    # I
...
.method private processServiceState(Landroid/os/AsyncResult;)V
    .locals 8
    ...
    iget v0, v3, Landroid/telephony/ServiceState;->oemPhoneId:I
    ...
    .line 2587
    sget-object v4, Lcom/android/internal/telephony/CallManager;->oldServiceState:[I
    ...
    const-string v5, " czp call getCallForwardingOption"

    invoke-static {v4, v5}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2591
    iget-object v4, p0, Lcom/android/internal/telephony/CallManager;->mHandler:Lcom/android/internal/telephony/CallManager$CallManagerHandler;

    const/16 v5, 0x362

    const/4 v6, 0x0

    invoke-virtual {v4, v5, v0, v6}, Lcom/android/internal/telephony/CallManager$CallManagerHandler;->obtainMessage(III)Landroid/os/Message;

    move-result-object v1

    .line 2592
    .local v1, "msg":Landroid/os/Message;
    iget v4, p0, Lcom/android/internal/telephony/CallManager;->counts:I

    rem-int/lit8 v4, v4, 0x2

    iput v4, p0, Lcom/android/internal/telephony/CallManager;->counts:I
    ...
    iget v5, p0, Lcom/android/internal/telephony/CallManager;->counts:I

    mul-int/lit16 v5, v5, 0x2710

    int-to-long v6, v5

    invoke-virtual {v4, v1, v6, v7}, Lcom/android/internal/telephony/CallManager$CallManagerHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private registerForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    .line 645
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mHandler:Lcom/android/internal/telephony/CallManager$CallManagerHandler;
