...
.field protected static final EVENT_SET_FACTORY_NV_RESULT:I = 0x3c
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mMdmVersion:Ljava/lang/String;
    ...
    iput-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->isWifiHotOpen:Z

    .line 226
    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->isWifiHotOpenOld:Z
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mImsCapabilityStatus:[Z
    ...
    iput v5, p0, Lcom/android/internal/telephony/PhoneBase;->hangup_retry_count:I
...
.method public getImsCapabilityStatus()[Z
    ...
    .prologue
    .line 1601
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mImsCapabilityStatus:[Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-virtual {p0, v2, v10, v11, v12}, Lcom/android/internal/telephony/PhoneBase;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    :try_end_0
    ...
    const-string v11, "get phone radio capability fail,no need to change mRadioCapability"
    ...
    const-string v12, "EVENT_GET_RADIO_CAPABILITY :phone rc : "
    ...
    const-string v12, "config LCE service failed: "
    ...
    iput v10, p0, Lcom/android/internal/telephony/PhoneBase;->mLceStatus:I
    ...
    iput v10, p0, Lcom/android/internal/telephony/PhoneBase;->mReportInterval:I
    ...
    const-string v11, "Event OEM_EVENT_GET_MDM_VERSION_DONE Received"
    ...
    const-string v11, "get modem version failed"
    ...
    const-string v12, "modem version:"

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p0, Lcom/android/internal/telephony/PhoneBase;->mMdmVersion:Ljava/lang/String;
    ...
    const-string v11, "Oem failed to EVENT_EM_DIAL_DONE."
    ...
    iget-object v11, p0, Lcom/android/internal/telephony/PhoneBase;->emTelNumber:Ljava/lang/String;

    invoke-direct {p0, v10, v11}, Lcom/android/internal/telephony/PhoneBase;->notifyEMTCallStatus(ILjava/lang/String;)V
    ...
    const-string v11, "oem succeed to EVENT_EM_DIAL_DONE."
    ...
    const-string v11, "Oem receive EVENT_EM_CALL_STATUS_CHANGED."
    ...
    const-string v11, "Oem failed to EVENT_EM_GET_CURRENT_CALLS_DONE."
    ...
    const-string v11, "Oem failed to EVENT_EM_HANGUP_DONE."

    invoke-static {v10, v11}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 832
    iget v10, p0, Lcom/android/internal/telephony/PhoneBase;->hangup_retry_count:I

    add-int/lit8 v10, v10, 0x1

    iput v10, p0, Lcom/android/internal/telephony/PhoneBase;->hangup_retry_count:I
    ...
    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/PhoneBase;->obtainMessage(I)Landroid/os/Message;

    move-result-object v11

    invoke-interface {v10, v11}, Lcom/android/internal/telephony/CommandsInterface;->hangupForegroundResumeBackground(Landroid/os/Message;)V
    ...
    const-string v11, "Oem succeed to EVENT_EM_HANGUP_DONE."
    ...
    const-string v11, "OEM_EVENT_NOTIFY_WIFI_STATUS_2_MODEM_DONE exception."
    ...
    const-string v11, "OEM_EVENT_NOTIFY_WIFI_STATUS_2_MODEM_DONE receive."
    ...
    const-string v11, "EVENT_SIM_RECORDS_DISPOSE"

    invoke-static {v10, v11}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 881
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getIccPhoneBookInterfaceManager()Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;

    move-result-object v10

    invoke-virtual {v10}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->dispose()V
    ...
    const-string v11, "Event EVENT_IMS_SERVICE_STATE_CHANGED Received"
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/telephony/PhoneBase;->notifyServiceStateChangedP(Landroid/telephony/ServiceState;)V
...
.method public oemMigrate(Landroid/os/RegistrantList;Landroid/os/RegistrantList;)V
    ...
    const-string v10, "leon oemMigrate:"
...
.method public onImsCapabilityStatusChange([Z)V
    ...
    .prologue
    .line 1605
    iput-object p1, p0, Lcom/android/internal/telephony/PhoneBase;->mImsCapabilityStatus:[Z
...
.method public onOtherPhoneInfoUpdated(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/PhoneBase;->onOtherPhoneCallStateUpdated(Ljava/lang/String;)V
...
.method public startMonitoringImsService()V
    ...
    invoke-interface {v2, p0, v3, v4}, Lcom/android/internal/telephony/CommandsInterface;->registerNVbackupresp(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public updateImsServiceConfig()V
    ...
    const-string v3, "updateImsServiceConfig mPhoneId = "
