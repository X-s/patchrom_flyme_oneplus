...
.method static synthetic access$000(Lcom/android/setupwizardlib/SetupWizardLayout;)Landroid/view/ViewTreeObserver$OnPreDrawListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/setupwizardlib/SetupWizardLayout;

    .prologue
    .line 49
    iget-object v0, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/setupwizardlib/SetupWizardLayout;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/setupwizardlib/SetupWizardLayout;

    .prologue
    .line 49
    iget v0, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mXFraction:F
...
.method private getScrollView()Lcom/android/setupwizardlib/view/BottomScrollView;
    .locals 2
    ...
    instance-of v1, v0, Lcom/android/setupwizardlib/view/BottomScrollView;
...
.method public requireScrollToBottom()V
    ...
    invoke-direct {p0}, Lcom/android/setupwizardlib/SetupWizardLayout;->getScrollView()Lcom/android/setupwizardlib/view/BottomScrollView;

    move-result-object v1

    .line 238
    .local v1, "scrollView":Lcom/android/setupwizardlib/view/BottomScrollView;
    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    .line 239
    invoke-static {v0, v1}, Lcom/android/setupwizardlib/util/RequireScrollHelper;->requireScroll(Lcom/android/setupwizardlib/view/NavigationBar;Lcom/android/setupwizardlib/view/BottomScrollView;)Lcom/android/setupwizardlib/util/RequireScrollHelper;
    ...
    const-string v3, "Both suw_layout_navigation_bar and suw_bottom_scroll_view must exist in the template to require scrolling."
...
.method public setXFraction(F)V
    ...
    .prologue
    .line 443
    iput p1, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mXFraction:F

    .line 444
    invoke-virtual {p0}, Lcom/android/setupwizardlib/SetupWizardLayout;->getWidth()I
    ...
    invoke-virtual {p0, v1}, Lcom/android/setupwizardlib/SetupWizardLayout;->setTranslationX(F)V
    ...
    .line 452
    :cond_1
    iget-object v1, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    if-nez v1, :cond_0

    .line 453
    new-instance v1, Lcom/android/setupwizardlib/SetupWizardLayout$1;

    invoke-direct {v1, p0}, Lcom/android/setupwizardlib/SetupWizardLayout$1;-><init>(Lcom/android/setupwizardlib/SetupWizardLayout;)V

    iput-object v1, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    .line 461
    invoke-virtual {p0}, Lcom/android/setupwizardlib/SetupWizardLayout;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v1

    iget-object v2, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
