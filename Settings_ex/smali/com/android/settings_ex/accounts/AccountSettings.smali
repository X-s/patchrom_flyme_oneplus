...
.field private mProfileNotAvailablePreference:Lcom/oneplus/widget/preference/OPPreference;
...
.method private newAddAccountPreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
    .locals 2
    .param p1, "context"    # Landroid/content/Context;

    .prologue
    .line 316
    new-instance v0, Lcom/oneplus/widget/preference/OPPreference;

    invoke-direct {v0, p1}, Lcom/oneplus/widget/preference/OPPreference;-><init>(Landroid/content/Context;)V

    .line 317
    .local v0, "preference":Lcom/oneplus/widget/preference/OPPreference;
    const v1, 0x7f0c0a60

    invoke-virtual {v0, v1}, Lcom/oneplus/widget/preference/OPPreference;->setTitle(I)V

    .line 318
    const v1, 0x7f02006f

    invoke-virtual {v0, v1}, Lcom/oneplus/widget/preference/OPPreference;->setIcon(I)V

    .line 319
    invoke-virtual {v0, p0}, Lcom/oneplus/widget/preference/OPPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V

    .line 320
    const/16 v1, 0x3e8

    invoke-virtual {v0, v1}, Lcom/oneplus/widget/preference/OPPreference;->setOrder(I)V

    .line 321
    return-object v0
.end method

.method private newAddOneplusAccountPreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    ...
    invoke-virtual {v0, v1}, Lcom/oneplus/widget/preference/OPPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V

    .line 348
    return-object v0
.end method

.method private newRemoveWorkProfilePreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
...
.method private updateAccountTypes(Lcom/android/settings_ex/accounts/AccountSettings$ProfileData;)V
    ...
    .line 413
    :cond_3
    iget-object v3, p0, Lcom/android/settings_ex/accounts/AccountSettings;->mProfileNotAvailablePreference:Lcom/oneplus/widget/preference/OPPreference;

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Lcom/oneplus/widget/preference/OPPreference;->setEnabled(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/oneplus/widget/preference/OPPreference;->setIcon(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/oneplus/widget/preference/OPPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Lcom/oneplus/widget/preference/OPPreference;->setSummary(I)V

    .line 418
    iget-object v3, p1, Lcom/android/settings_ex/accounts/AccountSettings$ProfileData;->preferenceGroup:Landroid/preference/PreferenceGroup;

    iget-object v4, p0, Lcom/android/settings_ex/accounts/AccountSettings;->mProfileNotAvailablePreference:Lcom/oneplus/widget/preference/OPPreference;
...
.method private updateProfileUi(Landroid/content/pm/UserInfo;ZLandroid/preference/PreferenceScreen;)V
    ...
    .line 295
    invoke-direct {p0, v0}, Lcom/android/settings_ex/accounts/AccountSettings;->newRemoveWorkProfilePreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
    ...
    .line 309
    invoke-direct {p0, v0}, Lcom/android/settings_ex/accounts/AccountSettings;->newAddAccountPreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v1}, Lcom/oneplus/widget/preference/OPPreference;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings_ex/accounts/AccountSettings;->mProfileNotAvailablePreference:Lcom/oneplus/widget/preference/OPPreference;
...
.method updateUi()V
    ...
    invoke-direct {p0, v7}, Lcom/android/settings_ex/accounts/AccountSettings;->newAddOneplusAccountPreference(Landroid/content/Context;)Lcom/oneplus/widget/preference/OPPreference;
