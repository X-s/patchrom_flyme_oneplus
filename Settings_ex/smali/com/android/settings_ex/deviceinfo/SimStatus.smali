...
.method private updateServiceState(Landroid/telephony/ServiceState;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/deviceinfo/SimStatus;->getApplicationContext()Landroid/content/Context;

    move-result-object v5

    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mSir:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-static {v5, v6}, Lcom/oneplus/settings/utils/OPSNSUtils;->getOpeName(Landroid/content/Context;I)Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/SimStatus;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mSignalStrength:Landroid/preference/Preference;

    .line 150
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mSelectableSubInfos:Ljava/util/List;
    ...
    :goto_0
    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mSir:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/SimStatus;->setContentView(I)V

    .line 158
    const v1, 0x1020012

    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/SimStatus;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/widget/TabHost;

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mTabWidget:Landroid/widget/TabWidget;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mListView:Landroid/widget/ListView;

    .line 162
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/SimStatus;->mTabListener:Landroid/widget/TabHost$OnTabChangeListener;
    ...
    invoke-static {v3, v0}, Lcom/oneplus/settings/utils/OPSNSUtils;->getSimName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/settings_ex/deviceinfo/SimStatus;->buildTabSpec(Ljava/lang/String;Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
