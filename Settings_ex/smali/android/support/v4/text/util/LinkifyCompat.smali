...
.method public static final addLinks(Landroid/text/Spannable;I)Z
    ...
    .line 110
    .end local v6    # "frameworkReturn":Z
    :cond_2
    ...
    iget-object v1, v8, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;->frameworkAddedSpan:Landroid/text/style/URLSpan;

    if-nez v1, :cond_7

    .line 136
    iget-object v1, v8, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;->url:Ljava/lang/String;

    iget v2, v8, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;->start:I

    iget v3, v8, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;->end:I

    invoke-static {v1, v2, v3, p0}, Landroid/support/v4/text/util/LinkifyCompat;->applyLink(Ljava/lang/String;IILandroid/text/Spannable;)V
...
.method private static final gatherMapLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    .line 419
    .local v7, "spec":Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;
    ...
    .end local v7    # "spec":Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;
    .end local v8    # "start":I
    :catch_0
    move-exception v3
    ...
    .restart local v7    # "spec":Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;
    .restart local v8    # "start":I
    :catch_1
    move-exception v2
