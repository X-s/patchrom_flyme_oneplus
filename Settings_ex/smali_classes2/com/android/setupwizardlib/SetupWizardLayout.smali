...
.method public getProgressBarColor()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 443
    iget-object v0, p0, Lcom/android/setupwizardlib/SetupWizardLayout;->mProgressBarColor:Landroid/content/res/ColorStateList;
...
.method public requireScrollToBottom()V
    ...
    instance-of v2, v1, Lcom/android/setupwizardlib/view/BottomScrollView;

    if-eqz v2, :cond_0

    .line 208
    check-cast v1, Lcom/android/setupwizardlib/view/BottomScrollView;

    .end local v1    # "scrollView":Landroid/widget/ScrollView;
    invoke-static {v0, v1}, Lcom/android/setupwizardlib/util/RequireScrollHelper;->requireScroll(Lcom/android/setupwizardlib/view/NavigationBar;Lcom/android/setupwizardlib/view/BottomScrollView;)V
    ...
    const-string/jumbo v3, "Both suw_layout_navigation_bar and suw_bottom_scroll_view must exist in the template to require scrolling."
