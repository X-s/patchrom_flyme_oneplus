.class public Lcom/android/settings_ex/SettingsDumpService;
...
.method private dumpDataUsage()Lorg/json/JSONObject;
    ...
    invoke-direct {v2, p0}, Lcom/android/settings_exlib/net/DataUsageController;-><init>(Landroid/content/Context;)V

    .line 77
    .local v2, "controller":Lcom/android/settings_exlib/net/DataUsageController;
    const-class v10, Landroid/net/ConnectivityManager;

    invoke-virtual {p0, v10}, Lcom/android/settings_ex/SettingsDumpService;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v6, v2}, Lcom/android/settings_ex/SettingsDumpService;->dumpDataUsage(Landroid/net/NetworkTemplate;Lcom/android/settings_exlib/net/DataUsageController;)Lorg/json/JSONObject;
    ...
    invoke-direct {p0, v11, v2}, Lcom/android/settings_ex/SettingsDumpService;->dumpDataUsage(Landroid/net/NetworkTemplate;Lcom/android/settings_exlib/net/DataUsageController;)Lorg/json/JSONObject;
...
.method private dumpDataUsage(Landroid/net/NetworkTemplate;Lcom/android/settings_exlib/net/DataUsageController;)Lorg/json/JSONObject;
    .locals 6
    .param p1, "template"    # Landroid/net/NetworkTemplate;
    .param p2, "controller"    # Lcom/android/settings_exlib/net/DataUsageController;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
    ...
    invoke-virtual {p2, p1}, Lcom/android/settings_exlib/net/DataUsageController;->getDataUsageInfo(Landroid/net/NetworkTemplate;)Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;

    move-result-object v1

    .line 104
    .local v1, "usage":Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;
    const-string/jumbo v2, "carrier"

    iget-object v3, v1, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;->carrier:Ljava/lang/String;
    ...
    iget-wide v4, v1, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;->startDate:J
    ...
    iget-wide v4, v1, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;->usageLevel:J
    ...
    iget-wide v4, v1, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;->warningLevel:J
    ...
    iget-wide v4, v1, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;->limitLevel:J
...
.method private dumpMemory()Lorg/json/JSONObject;
    ...
    new-instance v2, Lcom/android/settings_ex/applications/ProcStatsData;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/settings_ex/applications/ProcStatsData;-><init>(Landroid/content/Context;Z)V

    .line 63
    .local v2, "statsManager":Lcom/android/settings_ex/applications/ProcStatsData;
    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/android/settings_ex/applications/ProcStatsData;->refreshStats(Z)V
    ...
    iget-wide v4, v0, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;->realUsedRam:D
    ...
    iget-wide v4, v0, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;->realFreeRam:D
    ...
    iget-wide v4, v0, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;->realTotalRam:D
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/applications/ProcStatsData;->getMemState()I
...
.method private dumpStorage()Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/SettingsDumpService;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/SettingsDumpService;->dumpStorage()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/SettingsDumpService;->dumpDataUsage()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/SettingsDumpService;->dumpMemory()Lorg/json/JSONObject;
