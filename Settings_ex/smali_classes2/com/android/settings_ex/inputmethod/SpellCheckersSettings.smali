...
.method private populatePreferenceScreen()V
    ...
    .line 77
    new-instance v1, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;

    invoke-virtual {p0}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->getPrefContext()Landroid/content/Context;

    move-result-object v2

    .line 78
    iget-object v3, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mEnabledScis:[Landroid/view/textservice/SpellCheckerInfo;

    .line 77
    invoke-direct {v1, v2, v3}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;-><init>(Landroid/content/Context;[Landroid/view/textservice/SpellCheckerInfo;)V

    .line 79
    .local v1, "pref":Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;
    const v2, 0x7f0e1035

    invoke-virtual {v1, v2}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setTitle(I)V

    .line 80
    iget-object v2, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mEnabledScis:[Landroid/view/textservice/SpellCheckerInfo;
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 86
    :goto_1
    const-string/jumbo v2, "default_spellchecker"

    invoke-virtual {v1, v2}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setKey(Ljava/lang/String;)V

    .line 87
    invoke-virtual {v1, p0}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V

    .line 88
    invoke-virtual {p0}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setSummary(I)V
...
.method private showChooseLanguageDialog()V
    ...
    invoke-direct {p0, v2, v10}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->getSpellCheckerSubtypeLabel(Landroid/view/textservice/SpellCheckerInfo;Landroid/view/textservice/SpellCheckerSubtype;)Ljava/lang/CharSequence;
...
.method private showSecurityWarnDialog(Landroid/view/textservice/SpellCheckerInfo;)V
    ...
    .line 227
    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 235
    new-instance v1, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings$2;

    invoke-direct {v1, p0, p1}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings$2;-><init>(Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;Landroid/view/textservice/SpellCheckerInfo;)V
    ...
    .line 241
    new-instance v1, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings$3;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings$3;-><init>(Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;)V
    ...
    iput-object v1, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
...
.method private updatePreferenceScreen()V
    ...
    .line 124
    :goto_0
    iget-object v8, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/support/v7/preference/Preference;

    iget-object v9, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mCurrentSci:Landroid/view/textservice/SpellCheckerInfo;

    invoke-direct {p0, v9, v1}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->getSpellCheckerSubtypeLabel(Landroid/view/textservice/SpellCheckerInfo;Landroid/view/textservice/SpellCheckerSubtype;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, v8}, Lcom/android/settings_ex/inputmethod/SpellCheckerPreference;->setSelected(Landroid/view/textservice/SpellCheckerInfo;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/support/v7/preference/Preference;

    .line 68
    iget-object v0, p0, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/support/v7/preference/Preference;
...
.method public onPreferenceChange(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    :cond_1
    invoke-direct {p0, v1}, Lcom/android/settings_ex/inputmethod/SpellCheckersSettings;->showSecurityWarnDialog(Landroid/view/textservice/SpellCheckerInfo;)V
