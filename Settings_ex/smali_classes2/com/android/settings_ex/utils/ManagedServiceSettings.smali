...
# static fields
.field private static mConfig:Lcom/android/settings_ex/utils/ManagedServiceSettings$Config;

.field protected static mContext:Landroid/content/Context;

.field protected static mServiceListing:Lcom/android/settings_ex/utils/ServiceListing;
...
# direct methods
.method static synthetic -get0()Lcom/android/settings_ex/utils/ManagedServiceSettings$Config;
    .locals 1

    sget-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mConfig:Lcom/android/settings_ex/utils/ManagedServiceSettings$Config;
...
.method public constructor <init>()V
    ...
    sput-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mConfig:Lcom/android/settings_ex/utils/ManagedServiceSettings$Config;
...
.method private updateList(Ljava/util/List;)V
    ...
    .line 102
    sget-object v6, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mServiceListing:Lcom/android/settings_ex/utils/ServiceListing;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sput-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mContext:Landroid/content/Context;

    .line 61
    sget-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mContext:Landroid/content/Context;
    ...
    sget-object v1, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mContext:Landroid/content/Context;

    sget-object v2, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mConfig:Lcom/android/settings_ex/utils/ManagedServiceSettings$Config;
    ...
    sput-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mServiceListing:Lcom/android/settings_ex/utils/ServiceListing;

    .line 63
    sget-object v0, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mServiceListing:Lcom/android/settings_ex/utils/ServiceListing;
...
.method protected setEnabled(Landroid/content/ComponentName;Ljava/lang/String;Z)Z
    ...
    .line 117
    sget-object v1, Lcom/android/settings_ex/utils/ManagedServiceSettings;->mServiceListing:Lcom/android/settings_ex/utils/ServiceListing;

    invoke-virtual {v1, p1, v4}, Lcom/android/settings_ex/utils/ServiceListing;->setEnabled(Landroid/content/ComponentName;Z)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/settings_ex/utils/ServiceListing;->isEnabled(Landroid/content/ComponentName;)Z
    ...
    :cond_1
    :try_start_0
    new-instance v1, Lcom/android/settings_ex/utils/ManagedServiceSettings$ScaryWarningDialogFragment;

    invoke-direct {v1}, Lcom/android/settings_ex/utils/ManagedServiceSettings$ScaryWarningDialogFragment;-><init>()V

    invoke-virtual {v1, p1, p2}, Lcom/android/settings_ex/utils/ManagedServiceSettings$ScaryWarningDialogFragment;->setServiceInfo(Landroid/content/ComponentName;Ljava/lang/String;)Lcom/android/settings_ex/utils/ManagedServiceSettings$ScaryWarningDialogFragment;
    ...
    .line 125
    invoke-virtual {v1, v2, v3}, Lcom/android/settings_ex/utils/ManagedServiceSettings$ScaryWarningDialogFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    :try_end_0
    ...
    .line 129
    .local v0, "e":Landroid/app/Fragment$InstantiationException;
    invoke-virtual {v0}, Landroid/app/Fragment$InstantiationException;->printStackTrace()V
