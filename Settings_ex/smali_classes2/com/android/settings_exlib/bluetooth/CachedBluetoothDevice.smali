...
.method private processPhonebookAccess()V
    ...
    .line 846
    :cond_3
    invoke-virtual {p0, v3}, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->setPhonebookPermissionChoice(I)V
...
.method public getConnectionSummary()I
    ...
    const-string/jumbo v8, "STATE_CONNECTED mDevice = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 891
    instance-of v6, v3, Lcom/android/settings_exlib/bluetooth/HfpClientProfile;
    ...
    const-string/jumbo v8, "bluetooth_connected mDevice = "
    ...
    const-string/jumbo v8, "profileConnected = "
...
.method public getMaxConnectionState()I
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->getProfileConnectionState(Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;)I
...
.method onProfileStateChanged(Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;I)V
    ...
    invoke-interface {p1, v1, v5}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;->setPreferred(Landroid/bluetooth/BluetoothDevice;Z)V

    .line 140
    iget-object v1, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mRemovedProfiles:Ljava/util/List;

    invoke-interface {v1, p1}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    .line 141
    iget-object v1, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mProfiles:Ljava/util/List;
    ...
    invoke-virtual {p1, v1}, Lcom/android/settings_exlib/bluetooth/PanProfile;->isLocalRoleNap(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 148
    iput-boolean v5, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mLocalNapRoleConnected:Z
    ...
    invoke-interface {p1, v1, v4}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;->setPreferred(Landroid/bluetooth/BluetoothDevice;Z)V

    goto :goto_0

    .line 154
    :cond_5
    iget-boolean v1, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mLocalNapRoleConnected:Z
    ...
    .line 155
    check-cast v1, Lcom/android/settings_exlib/bluetooth/PanProfile;

    iget-object v2, p0, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v1, v2}, Lcom/android/settings_exlib/bluetooth/PanProfile;->isLocalRoleNap(Landroid/bluetooth/BluetoothDevice;)Z
