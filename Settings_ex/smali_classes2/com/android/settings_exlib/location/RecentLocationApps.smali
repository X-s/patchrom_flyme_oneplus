...
.method private getRequestFromOps(JLandroid/app/AppOpsManager$PackageOps;)Lcom/android/settings_exlib/location/RecentLocationApps$Request;
    ...
    .line 111
    .local v15, "entry":Landroid/app/AppOpsManager$OpEntry;
    ...
    .line 125
    .end local v15    # "entry":Landroid/app/AppOpsManager$OpEntry;
    :cond_2
    if-nez v8, :cond_3
    ...
    .line 139
    .local v19, "request":Lcom/android/settings_exlib/location/RecentLocationApps$Request;
    :try_start_0
    ...
    invoke-interface {v0, v3, v10, v1}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    .line 143
    sget-object v10, Lcom/android/settings_exlib/location/RecentLocationApps;->TAG:Ljava/lang/String;
    ...
    .end local v19    # "request":Lcom/android/settings_exlib/location/RecentLocationApps$Request;
    ...
    .restart local v19    # "request":Lcom/android/settings_exlib/location/RecentLocationApps$Request;
    ...
    iget-object v10, v0, Lcom/android/settings_exlib/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-virtual {v10, v12}, Landroid/content/pm/PackageManager;->getApplicationIcon(Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;

    move-result-object v11

    .line 150
    .local v11, "appIcon":Landroid/graphics/drawable/Drawable;
    move-object/from16 v0, p0

    iget-object v10, v0, Lcom/android/settings_exlib/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-virtual {v10, v11, v5}, Landroid/content/pm/PackageManager;->getUserBadgedIcon(Landroid/graphics/drawable/Drawable;Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, v7, v5}, Landroid/content/pm/PackageManager;->getUserBadgedLabel(Ljava/lang/CharSequence;Landroid/os/UserHandle;)Ljava/lang/CharSequence;

    move-result-object v9

    .line 153
    .local v9, "badgedAppLabel":Ljava/lang/CharSequence;
    ...
    .line 158
    .end local v9    # "badgedAppLabel":Ljava/lang/CharSequence;
    :cond_7
    new-instance v2, Lcom/android/settings_exlib/location/RecentLocationApps$Request;

    const/4 v10, 0x0

    invoke-direct/range {v2 .. v10}, Lcom/android/settings_exlib/location/RecentLocationApps$Request;-><init>(Ljava/lang/String;ILandroid/os/UserHandle;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Lcom/android/settings_exlib/location/RecentLocationApps$Request;)V
    :try_end_1
    ...
    .end local v11    # "appIcon":Landroid/graphics/drawable/Drawable;
    .end local v12    # "appInfo":Landroid/content/pm/ApplicationInfo;
    .end local v17    # "ipm":Landroid/content/pm/IPackageManager;
    .end local v19    # "request":Lcom/android/settings_exlib/location/RecentLocationApps$Request;
    ...
    invoke-static {v10, v0, v13}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
