...
.method public getDataUsageInfo(Landroid/net/NetworkTemplate;)Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;
    ...
    const-string/jumbo v27, "Cycle day="
    ...
    .line 150
    .local v19, "nowTime":Landroid/text/format/Time;
    ...
    .line 152
    .local v21, "policyTime":Landroid/text/format/Time;
    move-object/from16 v0, v20
    ...
    .line 166
    .end local v19    # "nowTime":Landroid/text/format/Time;
    .end local v21    # "policyTime":Landroid/text/format/Time;
    .local v8, "end":J
    :goto_0
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    const-string/jumbo v26, "history call from %s to %s now=%s took %sms: %s"
    ...
    .line 171
    invoke-static/range {v18 .. v18}, Lcom/android/settings_exlib/net/DataUsageController;->historyEntryToString(Landroid/net/NetworkStatsHistory$Entry;)Ljava/lang/String;
    ...
    .restart local v19    # "nowTime":Landroid/text/format/Time;
    .restart local v21    # "policyTime":Landroid/text/format/Time;
    :cond_3
    const/4 v12, -0x1
    ...
    new-instance v23, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;

    invoke-direct/range {v23 .. v23}, Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;-><init>()V

    .line 177
    .local v23, "usage":Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;
    ...
    .end local v16    # "callStart":J
    .end local v18    # "entry":Landroid/net/NetworkStatsHistory$Entry;
    .end local v23    # "usage":Lcom/android/settings_exlib/net/DataUsageController$DataUsageInfo;
    ...
    const-string/jumbo v12, "NullPointerException"
