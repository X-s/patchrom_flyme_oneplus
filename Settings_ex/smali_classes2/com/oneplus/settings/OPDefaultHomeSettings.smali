...
.method private resetDefaultHome(Landroid/support/v7/preference/Preference;)Z
    ...
    iget-object v9, p0, Lcom/oneplus/settings/OPDefaultHomeSettings;->mHomeComponentsPreferenceKeyMap:Ljava/util/Map;
    ...
    .line 169
    const-string/jumbo v9, "OPDefaultHomeSettings"

    const-string/jumbo v10, "set default home component error ,component is null ."
    ...
    .line 172
    :cond_0
    iget-object v9, p0, Lcom/oneplus/settings/OPDefaultHomeSettings;->mAllHomeComponents:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Lcom/oneplus/settings/OPDefaultHomeSettings;->mHomeFilter:Landroid/content/IntentFilter;

    const/high16 v11, 0x100000

    invoke-virtual {v9, v10, v11, v0, v1}, Landroid/content/pm/PackageManager;->replacePreferredActivity(Landroid/content/IntentFilter;I[Landroid/content/ComponentName;Landroid/content/ComponentName;)V
    ...
    iget-object v9, p0, Lcom/oneplus/settings/OPDefaultHomeSettings;->mRoot:Landroid/support/v7/preference/PreferenceScreen;

    invoke-virtual {v9, v7}, Landroid/support/v7/preference/PreferenceScreen;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v6

    check-cast v6, Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;

    .line 178
    .local v6, "pf":Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;
    invoke-virtual {v6, v12}, Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;->setChecked(Z)V

    goto :goto_0

    .end local v6    # "pf":Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;
    ...
    .line 181
    .local v8, "thisPf":Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;
    invoke-virtual {v8, v13}, Lcom/oneplus/settings/ui/OPRadioButtonPreferenceV7;->setChecked(Z)V

    .line 184
    :try_start_0
    iget-object v9, p0, Lcom/oneplus/settings/OPDefaultHomeSettings;->mCurrentDefaultHome:Landroid/content/ComponentName;
    ...
    .line 185
    .local v5, "lastPkgName":Ljava/lang/String;
    ...
    .line 187
    invoke-direct {p0, v5}, Lcom/oneplus/settings/OPDefaultHomeSettings;->forceStopPackage(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 194
    .end local v5    # "lastPkgName":Ljava/lang/String;
    :cond_2
    :goto_1
    return v13
    ...
    const-string/jumbo v10, "kill old default launcher maybe not success."
