...
.method private swapMoveOp(Ljava/util/List;II)V
    ...
    .line 47
    .local v3, "moveOp":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    invoke-interface {p1, p3}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;

    .line 48
    .local v5, "nextOp":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    iget v0, v5, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->cmd:I
    ...
    .line 50
    invoke-virtual/range {v0 .. v5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer;->swapMoveRemove(Ljava/util/List;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    .line 53
    invoke-direct/range {v0 .. v5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer;->swapMoveAdd(Ljava/util/List;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    .line 56
    invoke-virtual/range {v0 .. v5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer;->swapMoveUpdate(Ljava/util/List;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
...
.method swapMoveRemove(Ljava/util/List;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    .line 109
    .end local v0    # "extraRm":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    :cond_2
    :goto_1
    if-eqz v3, :cond_7
    ...
    .line 112
    iget-object v4, p0, Lcom/oneplus/lib/widget/recyclerview/OpReorderer;->mCallback:Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;

    invoke-interface {v4, p3}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;->recycleUpdateOp(Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    .restart local v0    # "extraRm":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    :cond_3
    const/4 v1, 0x1
    ...
    .line 88
    iput v8, p3, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->cmd:I

    .line 89
    iput v8, p3, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->itemCount:I
    ...
    invoke-interface {v4, p5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;->recycleUpdateOp(Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    invoke-interface {v4, v8, v5, v2, v7}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    ...
    iget v5, v0, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->positionStart:I
    ...
    iget v5, v0, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->itemCount:I

    sub-int/2addr v4, v5

    iput v4, p3, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->positionStart:I
...
.method swapMoveUpdate(Ljava/util/List;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;ILcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;)V
    ...
    .line 194
    .end local v0    # "extraUp1":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    :cond_0
    :goto_0
    ...
    .line 203
    .end local v1    # "extraUp2":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    :cond_1
    :goto_1
    invoke-interface {p1, p4, p3}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 188
    .restart local v0    # "extraUp1":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    .restart local v1    # "extraUp2":Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    :cond_4
    iget v3, p3, Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;->itemCount:I
    ...
    invoke-interface {v3, v7, v4, v6, v5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
    ...
    .line 199
    invoke-interface {v3, v7, v4, v2, v5}, Lcom/oneplus/lib/widget/recyclerview/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/oneplus/lib/widget/recyclerview/AdapterHelper$UpdateOp;
