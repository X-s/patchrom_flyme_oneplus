...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, v2, p4}, Lcom/oneplus/lib/widget/preference/OPPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 48
    const/16 v2, 0x64

    invoke-virtual {p0, v2}, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference;->setMax(I)V
...
.method protected onBindView(Landroid/view/View;)V
    ...
    .line 77
    sget v2, Lcom/oneplus/commonctrl/R$id;->seekbar:I
    ...
    .line 80
    sget v2, Lcom/oneplus/commonctrl/R$id;->opseekbar:I
    ...
    .line 82
    .local v0, "opSeekBar":Lcom/oneplus/lib/widget/OPSeekBar;
    if-eqz v0, :cond_0

    .line 83
    invoke-virtual {v0, p0}, Lcom/oneplus/lib/widget/OPSeekBar;->setOnSeekBarChangeListener(Lcom/oneplus/lib/widget/OPSeekBar$OnSeekBarChangeListener;)V

    .line 84
    iget v2, p0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference;->mMax:I

    invoke-virtual {v0, v2}, Lcom/oneplus/lib/widget/OPSeekBar;->setMax(I)V

    .line 85
    iget v2, p0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference;->mProgress:I

    invoke-virtual {v0, v2}, Lcom/oneplus/lib/widget/OPSeekBar;->setProgress(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/oneplus/lib/widget/OPSeekBar;->setEnabled(Z)V

    .line 87
    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lcom/oneplus/lib/widget/OPSeekBar;->setVisibility(I)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    const-class v2, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference$SavedState;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference$SavedState;-><init>(Landroid/os/Parcelable;)V

    .line 206
    .local v0, "myState":Lcom/oneplus/lib/widget/preference/OPSeekBarPreference$SavedState;
    iget v2, p0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference;->mProgress:I

    iput v2, v0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference$SavedState;->progress:I

    .line 207
    iget v2, p0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference;->mMax:I

    iput v2, v0, Lcom/oneplus/lib/widget/preference/OPSeekBarPreference$SavedState;->max:I
