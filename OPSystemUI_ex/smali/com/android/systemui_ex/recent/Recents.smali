.class public Lcom/android/systemui_ex/recent/Recents;
.super Lcom/android/systemui_ex/SystemUI;
.source "Recents.java"

# interfaces
.implements Lcom/android/systemui_ex/RecentsComponent;


# static fields
.field static sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/systemui_ex/recent/Recents;->mUseAlternateRecents:Z

    .line 48
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/systemui_ex/recent/Recents;->mBootCompleted:Z

    return-void
.end method

.method static synthetic access$000(Lcom/android/systemui_ex/recent/Recents;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/systemui_ex/recent/Recents;
    .param p1, "x1"    # Landroid/content/Intent;

    .prologue
    .line 42
    invoke-direct {p0, p1}, Lcom/android/systemui_ex/recent/Recents;->sendBroadcastSafely(Landroid/content/Intent;)V

    return-void
.end method

.method public static getRecentsComponent(Landroid/content/Context;Z)Lcom/android/systemui_ex/recents/AlternateRecentsComponent;
    .locals 1
    ...
    .prologue
    .line 54
    sget-object v0, Lcom/android/systemui_ex/recent/Recents;->sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;

    if-nez v0, :cond_0

    .line 55
    new-instance v0, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;

    invoke-direct {v0, p0}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/systemui_ex/recent/Recents;->sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;
    ...
    invoke-virtual {v0}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onStart()V

    .line 58
    sget-object v0, Lcom/android/systemui_ex/recent/Recents;->sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;

    invoke-virtual {v0}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onBootCompleted()V
...
.method private sendBroadcastSafely(Landroid/content/Intent;)V
    ...
    .prologue
    .line 315
    iget-boolean v0, p0, Lcom/android/systemui_ex/recent/Recents;->mBootCompleted:Z
    ...
    .line 316
    :cond_0
    iget-object v0, p0, Lcom/android/systemui_ex/recent/Recents;->mContext:Landroid/content/Context;
...
.method public cancelPreloadingRecents()V
    ...
    .prologue
    .line 278
    iget-boolean v1, p0, Lcom/android/systemui_ex/recent/Recents;->mUseAlternateRecents:Z

    if-eqz v1, :cond_0

    .line 279
    sget-object v1, Lcom/android/systemui_ex/recent/Recents;->sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;

    invoke-virtual {v1}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onCancelPreloadingRecents()V
    ...
    .line 284
    invoke-direct {p0, v0}, Lcom/android/systemui_ex/recent/Recents;->sendBroadcastSafely(Landroid/content/Intent;)V

    .line 286
    iget-object v1, p0, Lcom/android/systemui_ex/recent/Recents;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->getInstance(Landroid/content/Context;)Lcom/android/systemui_ex/recent/RecentTasksLoader;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->cancelPreloadingFirstTask()V
...
.method public hideRecents(ZZ)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onHideRecents(ZZ)V
...
.method protected onBootCompleted()V
    ...
    .prologue
    .line 78
    iget-boolean v0, p0, Lcom/android/systemui_ex/recent/Recents;->mUseAlternateRecents:Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public preloadRecents()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onPreloadRecents()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->preloadFirstTask()V

    goto :goto_0
.end method

.method public setCallback(Lcom/android/systemui_ex/RecentsComponent$Callbacks;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->setRecentsComponentCallback(Lcom/android/systemui_ex/RecentsComponent$Callbacks;)V
...
.method public showNextAffiliatedTask()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onShowNextAffiliatedTask()V
...
.method public showPrevAffiliatedTask()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onShowPrevAffiliatedTask()V
...
.method public showRecents(ZLandroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onShowRecents(Z)V
...
.method public start()V
    ...
    invoke-static {v0, v1}, Lcom/android/systemui_ex/recent/Recents;->getRecentsComponent(Landroid/content/Context;Z)Lcom/android/systemui_ex/recents/AlternateRecentsComponent;
    ...
    .line 73
    :cond_1
    const-class v0, Lcom/android/systemui_ex/RecentsComponent;

    invoke-virtual {p0, v0, p0}, Lcom/android/systemui_ex/recent/Recents;->putComponent(Ljava/lang/Class;Ljava/lang/Object;)V
...
.method public toggleRecents(Landroid/view/Display;ILandroid/view/View;)V
    ...
    iget-boolean v0, v0, Lcom/android/systemui_ex/recent/Recents;->mUseAlternateRecents:Z
    ...
    .line 110
    sget-object v34, Lcom/android/systemui_ex/recent/Recents;->sAlternateRecents:Lcom/android/systemui_ex/recents/AlternateRecentsComponent;

    invoke-virtual/range {v34 .. v34}, Lcom/android/systemui_ex/recents/AlternateRecentsComponent;->onToggleRecents()V
    ...
    iget-object v0, v0, Lcom/android/systemui_ex/recent/Recents;->mContext:Landroid/content/Context;

    move-object/from16 v34, v0

    invoke-static/range {v34 .. v34}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->getInstance(Landroid/content/Context;)Lcom/android/systemui_ex/recent/RecentTasksLoader;

    move-result-object v34

    invoke-virtual/range {v34 .. v34}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->getFirstTask()Lcom/android/systemui_ex/recent/TaskDescription;

    move-result-object v13

    .line 118
    .local v13, "firstTask":Lcom/android/systemui_ex/recent/TaskDescription;
    ...
    invoke-static/range {v34 .. v34}, Lcom/android/systemui_ex/recent/RecentsActivity;->forceOpaqueBackground(Landroid/content/Context;)Z
    ...
    const v35, 0x7f050069

    const v36, 0x7f05006a
    ...
    .line 250
    .end local v13    # "firstTask":Lcom/android/systemui_ex/recent/TaskDescription;
    ...
    .restart local v13    # "firstTask":Lcom/android/systemui_ex/recent/TaskDescription;
    ...
    invoke-virtual {v13}, Lcom/android/systemui_ex/recent/TaskDescription;->getThumbnail()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v34 .. v34}, Lcom/android/systemui_ex/recent/RecentTasksLoader;->getDefaultThumbnail()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_2
    new-instance v34, Lcom/android/systemui_ex/recent/Recents$1;

    move-object/from16 v0, v34

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/systemui_ex/recent/Recents$1;-><init>(Lcom/android/systemui_ex/recent/Recents;)V
    ...
    invoke-direct {v0, v15, v1}, Lcom/android/systemui_ex/recent/Recents;->startActivitySafely(Landroid/content/Intent;Landroid/os/Bundle;)V
