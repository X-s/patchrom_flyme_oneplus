...
.field public static final ACTION_THREE_KEY_BOOT_MEDIASERVERDIED:Ljava/lang/String; = "com.oem.intent.action.THREE_KEY_MODE_BOOT_MEDIASERVERDIED"

.field public static final ACTION_THREE_KEY_EXTRA:Ljava/lang/String; = "switch_state"
...
.field public static final SWITCH_STATE_DOWN:I

.field public static final SWITCH_STATE_MIDDLE:I

.field public static final SWITCH_STATE_ON:I
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/media/AudioManager;->sIsH2:Z

    .line 374
    sget-boolean v0, Landroid/media/AudioManager;->sIsH2:Z

    if-eqz v0, :cond_0

    :cond_0
    sput v2, Landroid/media/AudioManager;->SWITCH_STATE_ON:I
    ...
    :cond_1
    sput v3, Landroid/media/AudioManager;->SWITCH_STATE_MIDDLE:I
    ...
    :cond_2
    sput v4, Landroid/media/AudioManager;->SWITCH_STATE_DOWN:I
...
.method public setMode(I)V
    ...
    iget-object v8, p0, Landroid/media/AudioManager;->mApplicationContext:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getOpPackageName()Ljava/lang/String;

    move-result-object v8

    invoke-interface {v5, p1, v7, v8}, Landroid/media/IAudioService;->setMode(ILandroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
