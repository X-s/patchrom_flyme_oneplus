...
.field private static final DEFAULT_PHONE_COUNT:I = 0x3
...
.field private static final PROTECTED_MEDIA_PATH:[Ljava/lang/String;

.field private static final PROTECT_MEDIA:Z
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "persist.func.mp.protect_path"
    ...
    sput-boolean v0, Landroid/media/MediaScanner;->PROTECT_MEDIA:Z
    ...
    sput-object v0, Landroid/media/MediaScanner;->PROTECTED_MEDIA_PATH:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sput-object v0, Landroid/media/MediaScanner;->mExternalPath:Ljava/lang/String;
...
.method static synthetic access$000(Landroid/media/MediaScanner;)Landroid/media/MediaScanner$MyMediaScannerClient;
    .locals 1
...
.method private deleteNoMediaInProtectedPath()V
    .locals 7
    ...
    sget-object v5, Landroid/media/MediaScanner;->mExternalPath:Ljava/lang/String;
    ...
    .line 1767
    sget-boolean v4, Landroid/media/MediaScanner;->DBG:Z
    ...
    const-string v6, "deleteNoMediaInProtectedPath: "
    ...
    .local v2, "i":I
    :goto_1
    sget-object v4, Landroid/media/MediaScanner;->PROTECTED_MEDIA_PATH:[Ljava/lang/String;
    ...
    sget-object v5, Landroid/media/MediaScanner;->PROTECTED_MEDIA_PATH:[Ljava/lang/String;
    ...
    .line 1775
    .local v3, "protectedFile":Ljava/io/File;
    if-eqz v3, :cond_1
    ...
    .end local v2    # "i":I
    .end local v3    # "protectedFile":Ljava/io/File;
    :cond_2
    const-string v4, "MediaScanner"
    ...
    .restart local v3    # "protectedFile":Ljava/io/File;
    :cond_3
    const-string v4, "MediaScanner"
...
.method public static isNoMediaPath(Ljava/lang/String;)Z
    ...
    sget-boolean v8, Landroid/media/MediaScanner;->PROTECT_MEDIA:Z
    ...
    const-string v9, "Skip the media type of size 0 file: "
    ...
    sget-object v8, Landroid/media/MediaScanner;->mExternalPath:Ljava/lang/String;
...
.method public static isProtectedMediaPath(Ljava/lang/String;)Z
    ...
    sget-boolean v2, Landroid/media/MediaScanner;->PROTECT_MEDIA:Z
    ...
    .local v0, "i":I
    :goto_1
    sget-object v2, Landroid/media/MediaScanner;->PROTECTED_MEDIA_PATH:[Ljava/lang/String;
...
# virtual methods
.method public confirmRingtoneSettings()V
    .locals 4
    ...
    invoke-direct {v2, p0}, Landroid/media/MediaScanner$1;-><init>(Landroid/media/MediaScanner;)V
    ...
    new-instance v2, Landroid/media/MediaScanner$2;

    invoke-direct {v2, p0}, Landroid/media/MediaScanner$2;-><init>(Landroid/media/MediaScanner;)V
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1636
    :try_start_0
    sget-boolean v12, Landroid/media/MediaScanner;->PROTECT_MEDIA:Z

    if-eqz v12, :cond_0

    .line 1637
    invoke-direct/range {p0 .. p0}, Landroid/media/MediaScanner;->deleteNoMediaInProtectedPath()V
    ...
    .line 1665
    .local v4, "end":J
    sget-boolean v12, Landroid/media/MediaScanner;->DBG_LOGV:Z
