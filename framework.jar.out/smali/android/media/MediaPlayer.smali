...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Landroid/media/MediaPlayer;->mNotificationManager:Landroid/app/INotificationManager;
...
.method private isRestricted()Z
    ...
    .line 1212
    iget-boolean v5, p0, Landroid/media/MediaPlayer;->mBypassInterruptionPolicy:Z
    ...
    :cond_0
    :try_start_0
    iget v5, p0, Landroid/media/MediaPlayer;->mUsage:I
    ...
    .local v2, "usage":I
    :goto_1
    iget-object v5, p0, Landroid/media/MediaPlayer;->mAppOps:Lcom/android/internal/app/IAppOpsService;
    ...
    invoke-interface {v5, v6, v2, v7, v8}, Lcom/android/internal/app/IAppOpsService;->checkAudioOperation(IIILjava/lang/String;)I

    move-result v1

    .line 1223
    .local v1, "mode":I
    sget-boolean v5, Landroid/media/MediaPlayer;->DBG:Z
    ...
    const-string/jumbo v7, "isRestricted getPackagePriority = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Landroid/media/MediaPlayer;->mNotificationManager:Landroid/app/INotificationManager;
    ...
    invoke-interface {v7, v8, v9}, Landroid/app/INotificationManager;->getOnePlusPackagePriority(Ljava/lang/String;I)I
    ...
    invoke-interface {v7}, Landroid/app/INotificationManager;->getZenMode()I
    ...
    const-string v7, " ActivityThread.currentPackageName() =  "
    ...
    const-string v7, " getAudioStreamType =  "
    ...
    iget-object v6, p0, Landroid/media/MediaPlayer;->mNotificationManager:Landroid/app/INotificationManager;

    invoke-interface {v6}, Landroid/app/INotificationManager;->getZenMode()I
    ...
    iget-object v5, p0, Landroid/media/MediaPlayer;->mNotificationManager:Landroid/app/INotificationManager;
    ...
    invoke-interface {v5, v6, v7}, Landroid/app/INotificationManager;->getOnePlusPackagePriority(Ljava/lang/String;I)I
    ...
    invoke-static {v5}, Landroid/media/AudioAttributes;->usageForLegacyStreamType(I)I
    :try_end_0
