...
.method public enable()Z
    ...
    const-string v7, "CUSTOM_PERMISSION_CONTROL_BLUETOOTH"

    invoke-virtual {v2, v7}, Landroid/util/Permission;->requestPermissionAuto(Ljava/lang/String;)Z
    ...
    const-string v7, "enable(): BT is already enabled..!"
    ...
    const-string v7, "BT is in BLE_ON State"
    ...
    invoke-interface {v6}, Landroid/bluetooth/IBluetoothManager;->enable()Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public startLeScan(Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    const-string v2, "get call process name: "
...
.method public startLeScan([Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    const-string v11, "get call process name: "
    ...
    :cond_0
    :try_start_0
    iget-object v9, p0, Landroid/bluetooth/BluetoothAdapter;->mService:Landroid/bluetooth/IBluetooth;

    if-eqz v9, :cond_1

    iget-object v9, p0, Landroid/bluetooth/BluetoothAdapter;->mService:Landroid/bluetooth/IBluetooth;

    invoke-interface {v9}, Landroid/bluetooth/IBluetooth;->isSysIdle()Z
    ...
    const-string/jumbo v10, "system is idle do not do ble scan!!"
