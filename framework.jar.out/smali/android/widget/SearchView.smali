...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 159
    new-instance v12, Landroid/widget/SearchView$1;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$1;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mShowImeRunnable:Ljava/lang/Runnable;

    .line 170
    new-instance v12, Landroid/widget/SearchView$2;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$2;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mUpdateDrawableStateRunnable:Ljava/lang/Runnable;

    .line 176
    new-instance v12, Landroid/widget/SearchView$3;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$3;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mReleaseCursorRunnable:Ljava/lang/Runnable;
    ...
    iput-object v12, v0, Landroid/widget/SearchView;->mOutsideDrawablesCache:Ljava/util/WeakHashMap;

    .line 935
    new-instance v12, Landroid/widget/SearchView$6;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$6;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mOnClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v12, v0}, Landroid/widget/SearchView$7;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mTextKeyListener:Landroid/view/View$OnKeyListener;
    ...
    invoke-direct {v12, v0}, Landroid/widget/SearchView$8;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mOnEditorActionListener:Landroid/widget/TextView$OnEditorActionListener;
    ...
    iput-object v12, v0, Landroid/widget/SearchView;->mOnItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;

    .line 1426
    new-instance v12, Landroid/widget/SearchView$10;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$10;-><init>(Landroid/widget/SearchView;)V
    ...
    .line 1715
    new-instance v12, Landroid/widget/SearchView$11;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/widget/SearchView$11;-><init>(Landroid/widget/SearchView;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mTextWatcher:Landroid/text/TextWatcher;

    .line 271
    sget-object v12, Lcom/android/internal/R$styleable;->SearchView:[I
    ...
    invoke-virtual {v7, v9, v0, v12}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iget-object v12, v0, Landroid/widget/SearchView;->mCollapsedIcon:Landroid/widget/ImageView;
    ...
    .line 350
    .local v11, "queryHint":Landroid/text/SpannableString;
    ...
    invoke-direct {v12, v13, v14}, Landroid/text/style/AbsoluteSizeSpan;-><init>(IZ)V
    ...
    invoke-direct {v12, v11}, Landroid/text/SpannedString;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v4, v12, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    const-string v13, "android.speech.action.WEB_SEARCH"

    invoke-direct {v12, v13}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/widget/SearchView;->mVoiceWebSearchIntent:Landroid/content/Intent;

    .line 379
    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/widget/SearchView;->mVoiceWebSearchIntent:Landroid/content/Intent;
    ...
    const-string/jumbo v14, "web_search"
    ...
    iput-object v12, v0, Landroid/widget/SearchView;->mVoiceAppSearchIntent:Landroid/content/Intent;

    .line 384
    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/widget/SearchView;->mVoiceAppSearchIntent:Landroid/content/Intent;
    ...
    invoke-virtual {v12}, Landroid/widget/SearchView$SearchAutoComplete;->getDropDownAnchor()I
    ...
    iput-object v12, v0, Landroid/widget/SearchView;->mDropDownAnchor:Landroid/view/View;

    .line 387
    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/widget/SearchView;->mDropDownAnchor:Landroid/view/View;
    ...
    iget-boolean v12, v0, Landroid/widget/SearchView;->mIconifiedByDefault:Z

    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Landroid/widget/SearchView;->updateViewsVisibility(Z)V
    ...
    .end local v11    # "queryHint":Landroid/text/SpannableString;
    :cond_5
    const/16 v12, 0x9
