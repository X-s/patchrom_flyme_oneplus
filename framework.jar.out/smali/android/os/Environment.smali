...
.method private static getNoEmulatedVolume()Landroid/os/storage/StorageVolume;
    ...
    .prologue
    .line 83
    sget-object v4, Landroid/os/Environment;->sNoEmulatedVolume:Landroid/os/storage/StorageVolume;

    if-nez v4, :cond_1

    .line 84
    sget-object v5, Landroid/os/Environment;->sLock:Ljava/lang/Object;
    ...
    invoke-static {v2, v4}, Landroid/os/storage/StorageManager;->getVolumeList(II)[Landroid/os/storage/StorageVolume;

    move-result-object v3

    .line 93
    .local v3, "volumes":[Landroid/os/storage/StorageVolume;
    invoke-static {v3}, Landroid/os/storage/StorageManager;->getNoEmulatedVolume([Landroid/os/storage/StorageVolume;)Landroid/os/storage/StorageVolume;

    move-result-object v4

    sput-object v4, Landroid/os/Environment;->sNoEmulatedVolume:Landroid/os/storage/StorageVolume;
    :try_end_1
