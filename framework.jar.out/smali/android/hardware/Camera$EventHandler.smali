...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3, v4, v5}, Landroid/hardware/Camera;->access$600(Landroid/hardware/Camera;ZZ)V
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$800(Landroid/hardware/Camera;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$1300(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusMoveCallback;
    ...
    invoke-static {v3, v4}, Landroid/hardware/Camera;->access$1400([BI)I
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraDataCallback;
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraMetaDataCallback;
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$1700(Landroid/hardware/Camera;)Landroid/hardware/Camera$AECallback;
    ...
    invoke-interface {v3, v4, v5}, Landroid/hardware/Camera$AECallback;->onAEChanged(ILandroid/hardware/Camera;)V
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$OneplusCallback;
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$1900(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    # getter for: Landroid/hardware/Camera;->mMetadata:Landroid/hardware/camera2/impl/CameraMetadataNative;
    invoke-static {v3}, Landroid/hardware/Camera;->access$1900(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    # getter for: Landroid/hardware/Camera;->mMetadata:Landroid/hardware/camera2/impl/CameraMetadataNative;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1900(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
