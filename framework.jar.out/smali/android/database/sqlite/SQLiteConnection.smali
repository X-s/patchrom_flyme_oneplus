...
.field private static mSQLJournalModeWhiteList:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    .line 128
    invoke-static {}, Landroid/database/sqlite/SQLiteGlobal;->getJournalModeWhiteList()[Ljava/lang/String;

    move-result-object v0

    sput-object v0, Landroid/database/sqlite/SQLiteConnection;->mSQLJournalModeWhiteList:[Ljava/lang/String;
...
.method private hoistAndroidDefaultJournalMode(Z)V
    .locals 3
    .param p1, "forceHoist"    # Z
    ...
    .line 339
    .local v0, "currMode":Ljava/lang/String;
    if-nez p1, :cond_1
    ...
    .line 347
    :cond_2
    sget-object v1, Landroid/database/sqlite/SQLiteConnection;->ANDROID_DEFAULT_JOURNAL_MODE:Ljava/lang/String;
...
.method private open()V
    ...
    iget-object v9, v9, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->path:Ljava/lang/String;
    ...
    iget v10, v10, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->openFlags:I
    ...
    sget-boolean v12, Landroid/database/sqlite/SQLiteDebug;->DEBUG_SQL_STATEMENTS:Z

    sget-boolean v13, Landroid/database/sqlite/SQLiteDebug;->DEBUG_SQL_TIME:Z

    invoke-static {v9, v10, v11, v12, v13}, Landroid/database/sqlite/SQLiteConnection;->nativeOpen(Ljava/lang/String;ILjava/lang/String;ZZ)J

    move-result-wide v10

    iput-wide v10, p0, Landroid/database/sqlite/SQLiteConnection;->mConnectionPtr:J
    ...
    .line 234
    .local v0, "SQLWhiteListMatched":Z
    sget-object v1, Landroid/database/sqlite/SQLiteConnection;->mSQLJournalModeWhiteList:[Ljava/lang/String;
    ...
    .line 244
    :cond_2
    invoke-direct {p0, v7}, Landroid/database/sqlite/SQLiteConnection;->hoistAndroidDefaultJournalMode(Z)V
    ...
    iget-object v9, v9, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->customFunctions:Ljava/util/ArrayList;
    ...
    invoke-static {v10, v11, v2}, Landroid/database/sqlite/SQLiteConnection;->nativeRegisterCustomFunction(JLandroid/database/sqlite/SQLiteCustomFunction;)V
