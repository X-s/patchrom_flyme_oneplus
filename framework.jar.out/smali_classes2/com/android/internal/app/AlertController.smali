...
.method static constructor <clinit>()V
    ...
    :array_0
    .array-data 4
        #android:string@uc_ringtones_oneplus_tune#t
        #android:string@uc_ringtones_longing#t
        #android:string@uc_ringtones_sinnocence#t
        #android:string@uc_ringtones_journey#t
        #android:string@uc_ringtones_cap#t
        #android:string@uc_ringtones_beep#t
        #android:string@uc_ringtones_Smart#t
        #android:string@uc_ringtones_echo#t
        #android:string@uc_ringtones_talk_about#t
        #android:string@uc_ringtones_rotation#t
        #android:string@uc_ringtones_cloud#t
        #android:string@uc_ringtones_old#t
        #android:string@uc_notifications_free#t
        #android:string@uc_notifications_harp#t
        #android:string@uc_notifications_ding#t
        #android:string@uc_notifications_surprise#t
        #android:string@uc_notifications_drops#t
        #android:string@uc_notifications_linger#t
        #android:string@uc_notifications_meet#t
        #android:string@uc_notifications_elegant#t
        #android:string@uc_notifications_quickly#t
        #android:string@uc_notifications_tactfully#t
        #android:string@uc_notifications_wind_chime#t
        #android:string@uc_notifications_distant#t
        #android:string@uc_alarms_spring#t
        #android:string@uc_alarms_walking_in_the_rain#t
        #android:string@uc_alarms_alarm_clock1#t
        #android:string@uc_alarms_alarm_clock2#t
        #android:string@uc_alarms_flyer#t
        #android:string@uc_alarms_a_starry_night#t
    .end array-data
.end method
