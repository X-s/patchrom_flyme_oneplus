...
.field static final TRANSACTION_hideSoftInputForLongshot:I = 0x21
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 55
    .local v36, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodInfo;>;"
    ...
    .line 61
    .end local v36    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodInfo;>;"
    :sswitch_2
    const-string/jumbo v4, "com.android.internal.view.IInputMethodManager"
    ...
    .line 63
    .restart local v36    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 75
    .local v37, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v37    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;"
    :cond_0
    const/16 v25, 0x0
    ...
    .line 83
    .local v32, "_result":Landroid/view/inputmethod/InputMethodSubtype;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 95
    .end local v32    # "_result":Landroid/view/inputmethod/InputMethodSubtype;
    :sswitch_5
    const-string/jumbo v4, "com.android.internal.view.IInputMethodManager"
    ...
    .line 109
    .local v23, "_arg1":Lcom/android/internal/view/IInputContext;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v23    # "_arg1":Lcom/android/internal/view/IInputContext;
    ...
    .local v28, "_arg2":Landroid/os/ResultReceiver;
    goto :goto_2

    .line 150
    .end local v28    # "_arg2":Landroid/os/ResultReceiver;
    ...
    .restart local v28    # "_arg2":Landroid/os/ResultReceiver;
    goto :goto_4
    ...
    .line 199
    .local v34, "_result":Lcom/android/internal/view/InputBindResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v34    # "_result":Lcom/android/internal/view/InputBindResult;
    :cond_6
    const/4 v11, 0x0
    ...
    .restart local v34    # "_result":Lcom/android/internal/view/InputBindResult;
    :cond_7
    const/4 v4, 0x0
    ...
    .local v29, "_arg2":Landroid/view/inputmethod/InputMethodSubtype;
    goto :goto_8

    .line 262
    .end local v14    # "_arg0":Landroid/os/IBinder;
    .end local v24    # "_arg1":Ljava/lang/String;
    .end local v29    # "_arg2":Landroid/view/inputmethod/InputMethodSubtype;
    :sswitch_10
    const-string/jumbo v4, "com.android.internal.view.IInputMethodManager"
    ...
    .line 340
    .restart local v32    # "_result":Landroid/view/inputmethod/InputMethodSubtype;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 416
    .local v26, "_arg1":[Landroid/view/inputmethod/InputMethodSubtype;
    move-object/from16 v0, p0
    ...
    .line 422
    .end local v18    # "_arg0":Ljava/lang/String;
    .end local v26    # "_arg1":[Landroid/view/inputmethod/InputMethodSubtype;
    :sswitch_1d
    const-string/jumbo v4, "com.android.internal.view.IInputMethodManager"
    ...
    .line 452
    .local v33, "_result":Lcom/android/internal/inputmethod/IInputContentUriToken;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 453
    if-eqz v33, :cond_15

    invoke-interface/range {v33 .. v33}, Lcom/android/internal/inputmethod/IInputContentUriToken;->asBinder()Landroid/os/IBinder;
    ...
    .end local v33    # "_result":Lcom/android/internal/inputmethod/IInputContentUriToken;
    :cond_14
    const/16 v21, 0x0
    ...
    .restart local v30    # "_arg2":Ljava/lang/String;
    .restart local v33    # "_result":Lcom/android/internal/inputmethod/IInputContentUriToken;
    :cond_15
    const/4 v4, 0x0
    ...
    .local v22, "_arg1":Landroid/os/ResultReceiver;
    goto :goto_16

    .line 478
    .end local v22    # "_arg1":Landroid/os/ResultReceiver;
    .restart local v38    # "_result":Z
    :cond_17
    const/4 v4, 0x0
