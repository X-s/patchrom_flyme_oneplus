...
.method public requestSetTipTextPaintAttr(I)I
    ...
    .line 70
    const-string/jumbo v3, "OEMAssertTip"

    const-string/jumbo v4, "size is too small! set larger than 10."
    ...
    .line 76
    invoke-virtual {v2, v1, v5, v4}, Landroid/graphics/Paint;->measureText([CII)F
...
.method public requestShowAssertMessage(Ljava/lang/String;)I
    ...
    .line 61
    :cond_0
    const-string/jumbo v0, "OEMAssertTip"
