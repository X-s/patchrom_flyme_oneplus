...
.method protected get(Ljava/io/Serializable;Ljava/lang/Object;Landroid/graphics/Bitmap;J)Landroid/graphics/Bitmap;
    ...
    .line 87
    .end local p3    # "defaultValue":Landroid/graphics/Bitmap;
    :cond_0
    :goto_0
    return-object p3

    .line 68
    .restart local p3    # "defaultValue":Landroid/graphics/Bitmap;
    :cond_1
    ...
    const-string v6, "get() - Fail to copy bitmap as "
...
.method protected getSizeInBytes(Ljava/io/Serializable;Landroid/graphics/Bitmap;)J
    ...
    :try_start_1
    iget-object v3, p0, Lcom/oneplus/cache/CompressedBitmapLruCache;->m_CompressFormat:Landroid/graphics/Bitmap$CompressFormat;
    ...
    .line 99
    .local v0, "data":[B
    iget-object v3, p0, Lcom/oneplus/cache/CompressedBitmapLruCache;->m_CompressedBitmaps:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p0, Lcom/oneplus/cache/CompressedBitmapLruCache;->TAG:Ljava/lang/String;

    const-string v4, "getSizeInBytes() - Fail to compress bitmap"
