...
.method static synthetic access$100(Lcom/oneplus/gallery/GalleryActivity;)Lcom/oneplus/base/Handle;
    .locals 1
    .param p0, "x0"    # Lcom/oneplus/gallery/GalleryActivity;
...
.method static synthetic access$102(Lcom/oneplus/gallery/GalleryActivity;Lcom/oneplus/base/Handle;)Lcom/oneplus/base/Handle;
    .locals 0
    .param p0, "x0"    # Lcom/oneplus/gallery/GalleryActivity;
...
.method static synthetic access$200(Lcom/oneplus/gallery/GalleryActivity;Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;)V
    .locals 0
    .param p0, "x0"    # Lcom/oneplus/gallery/GalleryActivity;
    .param p1, "x1"    # Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;
...
.method private checkBacklight()V
    ...
    .line 212
    invoke-direct {p0, v3}, Lcom/oneplus/gallery/GalleryActivity;->updateBacklightBrightness(I)V
...
.method private static checkInstances(J)V
    ...
    sget-object v3, Lcom/oneplus/gallery/GalleryActivity;->m_CheckInstancesRunnable:Ljava/lang/Runnable;
    ...
    .line 224
    sget-object v3, Lcom/oneplus/gallery/GalleryActivity;->m_TrackingInstances:Ljava/util/List;
    ...
    sget-object v5, Lcom/oneplus/gallery/GalleryActivity;->m_TrackingInstances:Ljava/util/List;
...
.method private restoreStatusBarStyle(Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;)V
    .locals 2
    .param p1, "handle"    # Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;
...
.method private static trackInstance(Lcom/oneplus/gallery/GalleryActivity;)V
    .locals 2
    .param p0, "instance"    # Lcom/oneplus/gallery/GalleryActivity;
...
.method private updateBacklightBrightness(I)V
    ...
    .prologue
    .line 796
    iget-object v3, p0, Lcom/oneplus/gallery/GalleryActivity;->TAG:Ljava/lang/String;
...
.method private updateStatusBarStyle()V
    ...
    check-cast v1, Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;

    iget-boolean v1, v1, Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;->isLightStyle:Z
    ...
    invoke-virtual {p0, v1}, Lcom/oneplus/gallery/GalleryActivity;->get(Lcom/oneplus/base/PropertyKey;)Ljava/lang/Object;
...
.method protected getRequestPermissions(Ljava/util/List;)V
    ...
    .line 325
    sget-object v0, Lcom/oneplus/gallery/GalleryActivity;->PERMISSION_REQUEST_LIST:[Ljava/lang/String;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 360
    .local v0, "handle":Lcom/oneplus/gallery/GalleryActivity$ActivityResultHandle;
    if-eqz v0, :cond_1
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    .line 404
    sget-object v5, Lcom/oneplus/gallery/GalleryActivity;->STATE_KEY_PID:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_Gallery:Lcom/oneplus/gallery/Gallery;

    .line 423
    iget-object v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_Gallery:Lcom/oneplus/gallery/Gallery;
    ...
    invoke-virtual {v5}, Lcom/oneplus/gallery/GalleryApplication;->createGallery()Lcom/oneplus/gallery/Gallery;
    ...
    iput-boolean v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_IsSharedGallery:Z
    ...
    invoke-virtual {v5, p0}, Lcom/oneplus/gallery/Gallery;->attachActivity(Lcom/oneplus/gallery/GalleryActivity;)Lcom/oneplus/base/Handle;

    move-result-object v5

    iput-object v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_GalleryAttachHandle:Lcom/oneplus/base/Handle;

    .line 444
    iget-object v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_GalleryAttachHandle:Lcom/oneplus/base/Handle;
    ...
    iget-object v7, p0, Lcom/oneplus/gallery/GalleryActivity;->m_Gallery:Lcom/oneplus/gallery/Gallery;

    invoke-virtual {v7}, Lcom/oneplus/gallery/Gallery;->getId()Ljava/lang/String;
    ...
    iget-boolean v7, p0, Lcom/oneplus/gallery/GalleryActivity;->m_IsSharedGallery:Z
    ...
    iget-object v7, p0, Lcom/oneplus/gallery/GalleryActivity;->m_NavBarVisibilityCallback:Lcom/oneplus/base/PropertyChangedCallback;

    invoke-virtual {v5, v6, v7}, Lcom/oneplus/gallery/Gallery;->addCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V
    ...
    iget-object v7, p0, Lcom/oneplus/gallery/GalleryActivity;->m_StatusBarVisibilityCallback:Lcom/oneplus/base/PropertyChangedCallback;
    ...
    check-cast v3, Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;

    .line 460
    .local v3, "stateFragment":Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;
    if-eqz v3, :cond_8

    iget-object v5, v3, Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;->activityResultHandles:Landroid/util/SparseArray;
    ...
    iput-object v5, p0, Lcom/oneplus/gallery/GalleryActivity;->m_ActivityResultHandles:Landroid/util/SparseArray;

    .line 472
    :goto_4
    if-eqz v3, :cond_7

    iget-object v4, v3, Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;->extras:Ljava/util/Map;

    :cond_7
    invoke-virtual {p0, p1, v4}, Lcom/oneplus/gallery/GalleryActivity;->onCreate(Landroid/os/Bundle;Ljava/util/Map;)V
...
.method protected onDestroy()V
    ...
    iget-object v4, p0, Lcom/oneplus/gallery/GalleryActivity;->m_NavBarVisibilityCallback:Lcom/oneplus/base/PropertyChangedCallback;

    invoke-virtual {v2, v3, v4}, Lcom/oneplus/gallery/Gallery;->removeCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V
    ...
    iget-object v4, p0, Lcom/oneplus/gallery/GalleryActivity;->m_StatusBarVisibilityCallback:Lcom/oneplus/base/PropertyChangedCallback;

    invoke-virtual {v2, v3, v4}, Lcom/oneplus/gallery/Gallery;->removeCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V

    .line 496
    iget-object v2, p0, Lcom/oneplus/gallery/GalleryActivity;->m_GalleryAttachHandle:Lcom/oneplus/base/Handle;

    invoke-static {v2}, Lcom/oneplus/base/Handle;->close(Lcom/oneplus/base/Handle;)Lcom/oneplus/base/Handle;

    move-result-object v2

    iput-object v2, p0, Lcom/oneplus/gallery/GalleryActivity;->m_GalleryAttachHandle:Lcom/oneplus/base/Handle;

    .line 499
    iget-boolean v2, p0, Lcom/oneplus/gallery/GalleryActivity;->m_IsInstanceStateSaved:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/oneplus/gallery/GalleryActivity;->m_IsSharedGallery:Z
    ...
    invoke-virtual {v2}, Lcom/oneplus/gallery/Gallery;->release()V
    ...
    invoke-interface {v2, v0, v3, v5}, Lcom/oneplus/gallery/GalleryActivity$ActivityResultCallback;->onActivityResult(Lcom/oneplus/base/Handle;ILandroid/content/Intent;)V
    ...
    .line 522
    .end local v0    # "handle":Lcom/oneplus/gallery/GalleryActivity$ActivityResultHandle;
    ...
    invoke-static {v2, v3}, Lcom/oneplus/gallery/GalleryActivity;->checkInstances(J)V
...
.method protected onInitialPermissionsRequestCompleted([Ljava/lang/String;[I)Z
    ...
    .line 543
    .local v1, "app":Lcom/oneplus/gallery/GalleryApplication;
    array-length v4, p1
    ...
    invoke-virtual {v1, v4}, Lcom/oneplus/gallery/GalleryApplication;->notifyPermissionDenied(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4}, Lcom/oneplus/gallery/GalleryApplication;->notifyPermissionGranted(Ljava/lang/String;)V
...
.method protected final onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 582
    .local v0, "stateFragment":Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;
    if-eqz v0, :cond_0

    iget-object v1, v0, Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;->extras:Ljava/util/Map;

    :goto_0
    invoke-virtual {p0, p1, v1}, Lcom/oneplus/gallery/GalleryActivity;->onRestoreInstanceState(Landroid/os/Bundle;Ljava/util/Map;)V
...
.method protected final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .end local v0    # "stateFragment":Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;
    invoke-direct {v0}, Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;-><init>()V

    .line 619
    .restart local v0    # "stateFragment":Lcom/oneplus/gallery/GalleryActivity$InstanceStateFragment;
    invoke-virtual {p0}, Lcom/oneplus/gallery/GalleryActivity;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    invoke-virtual {p0, p1, v1}, Lcom/oneplus/gallery/GalleryActivity;->onSaveInstanceState(Landroid/os/Bundle;Ljava/util/Map;)V
    ...
    iput-boolean v1, p0, Lcom/oneplus/gallery/GalleryActivity;->m_IsInstanceStateSaved:Z
...
.method public setStatusBarStyle(Z)Lcom/oneplus/base/Handle;
    ...
    .line 704
    .local v0, "handle":Lcom/oneplus/gallery/GalleryActivity$StatusBarStyleHandle;
    iget-object v1, p0, Lcom/oneplus/gallery/GalleryActivity;->m_StatusBarStyleHandles:Ljava/util/LinkedList;
...
.method public startActivityForResult(Landroid/content/Intent;Lcom/oneplus/gallery/GalleryActivity$ActivityResultCallback;)Lcom/oneplus/base/Handle;
    ...
    .param p2, "callback"    # Lcom/oneplus/gallery/GalleryActivity$ActivityResultCallback;
    ...
    .line 758
    iget-object v4, p0, Lcom/oneplus/gallery/GalleryActivity;->m_ActivityResultHandles:Landroid/util/SparseArray;
    ...
    .line 769
    .local v1, "handle":Lcom/oneplus/gallery/GalleryActivity$ActivityResultHandle;
    iget-object v4, p0, Lcom/oneplus/gallery/GalleryActivity;->m_ActivityResultHandles:Landroid/util/SparseArray;
    ...
    .line 774
    :try_start_0
    invoke-virtual {p0, p1, v2}, Lcom/oneplus/gallery/GalleryActivity;->startActivityForResult(Landroid/content/Intent;I)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
