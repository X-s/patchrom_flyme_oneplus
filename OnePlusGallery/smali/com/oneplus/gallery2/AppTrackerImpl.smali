.class final Lcom/oneplus/gallery2/AppTrackerImpl;
.super Lcom/oneplus/base/component/BasicComponent;
.source "AppTrackerImpl.java"

# interfaces
.implements Lcom/oneplus/gallery2/AppTracker;
...
# direct methods
.method public constructor <init>(Lcom/oneplus/gallery2/GalleryApplication;)V
    .locals 2
    .param p1, "application"    # Lcom/oneplus/gallery2/GalleryApplication;
    ...
    iput-object v0, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Record:Ljava/util/Map;

    .line 37
    return-void
.end method

.method private createLaunchRecord(Ljava/util/Map;Lcom/oneplus/gallery2/ActivityLaunchType;)Z
    .locals 2
    ...
    invoke-virtual {p2}, Lcom/oneplus/gallery2/ActivityLaunchType;->toString()Ljava/lang/String;
...
.method private createMediaSetCreationDeletionRecord(Ljava/util/Map;Lcom/oneplus/gallery2/media/MediaSet$Type;Ljava/lang/String;)Z
    .locals 2
    .param p2, "type"    # Lcom/oneplus/gallery2/media/MediaSet$Type;
    ...
    invoke-virtual {p2}, Lcom/oneplus/gallery2/media/MediaSet$Type;->toString()Ljava/lang/String;
...
.method public varargs createRecord(Ljava/lang/String;I[Ljava/lang/Object;)Z
    ...
    .line 76
    invoke-virtual {p0}, Lcom/oneplus/gallery2/AppTrackerImpl;->verifyAccess()V

    .line 77
    iget-object v1, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Tracker:Ljava/lang/Object;
    ...
    .line 140
    iget-object v1, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Record:Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Record:Ljava/util/Map;

    const/4 v1, 0x0

    aget-object v1, p3, v1

    check-cast v1, Lcom/oneplus/gallery2/media/MediaSet$Type;
    ...
    invoke-direct {p0, v5, v1, v2}, Lcom/oneplus/gallery2/AppTrackerImpl;->createMediaSetCreationDeletionRecord(Ljava/util/Map;Lcom/oneplus/gallery2/media/MediaSet$Type;Ljava/lang/String;)Z
    :try_end_1
    ...
    iget-object v2, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Record:Ljava/util/Map;

    const/4 v1, 0x0

    aget-object v1, p3, v1

    check-cast v1, Lcom/oneplus/gallery2/ActivityLaunchType;

    invoke-direct {p0, v2, v1}, Lcom/oneplus/gallery2/AppTrackerImpl;->createLaunchRecord(Ljava/util/Map;Lcom/oneplus/gallery2/ActivityLaunchType;)Z
    :try_end_2
    ...
    invoke-direct {p0, v2, v1}, Lcom/oneplus/gallery2/AppTrackerImpl;->createLeaveRecord(Ljava/util/Map;Ljava/lang/String;)Z
    :try_end_3
    ...
    .line 130
    iget-object v1, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_TrackerOnEventMethod:Ljava/lang/reflect/Method;

    iget-object v2, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Tracker:Ljava/lang/Object;
    ...
    iget-object v7, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Record:Ljava/util/Map;
...
.method protected onInitialize()V
    ...
    iput-object v4, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_TrackerOnEventMethod:Ljava/lang/reflect/Method;
    ...
    iput-object v4, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Tracker:Ljava/lang/Object;
    ...
    .line 170
    .local v0, "app":Lcom/oneplus/gallery2/GalleryApplication;
    sget-object v4, Lcom/oneplus/gallery2/GalleryApplication;->EVENT_ACTIVITY_LAUNCHED:Lcom/oneplus/base/EventKey;

    new-instance v5, Lcom/oneplus/gallery2/AppTrackerImpl$1;

    invoke-direct {v5, p0}, Lcom/oneplus/gallery2/AppTrackerImpl$1;-><init>(Lcom/oneplus/gallery2/AppTrackerImpl;)V

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/gallery2/GalleryApplication;->addHandler(Lcom/oneplus/base/EventKey;Lcom/oneplus/base/EventHandler;)V

    .line 178
    return-void

    .line 161
    .end local v0    # "app":Lcom/oneplus/gallery2/GalleryApplication;
    :catch_0
    move-exception v1
    ...
    .line 164
    iput-object v8, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_Tracker:Ljava/lang/Object;

    .line 165
    iput-object v8, p0, Lcom/oneplus/gallery2/AppTrackerImpl;->m_TrackerOnEventMethod:Ljava/lang/reflect/Method;
