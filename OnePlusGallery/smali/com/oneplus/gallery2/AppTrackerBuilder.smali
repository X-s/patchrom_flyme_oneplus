.class final Lcom/oneplus/gallery2/AppTrackerBuilder;
...
.method public varargs create([Ljava/lang/Object;)Lcom/oneplus/base/component/Component;
    ...
    instance-of v0, v0, Lcom/oneplus/gallery2/GalleryApplication;

    if-eqz v0, :cond_0

    .line 188
    new-instance v1, Lcom/oneplus/gallery2/AppTrackerImpl;

    aget-object v0, p1, v2

    check-cast v0, Lcom/oneplus/gallery2/GalleryApplication;

    invoke-direct {v1, v0}, Lcom/oneplus/gallery2/AppTrackerImpl;-><init>(Lcom/oneplus/gallery2/GalleryApplication;)V
