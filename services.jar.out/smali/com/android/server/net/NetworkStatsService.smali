...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .end local v18    # "includeTag":Z
    .end local v19    # "includeUid":Z
    .end local v22    # "poll":Z
    ...
    .line 1181
    .restart local v19    # "includeUid":Z
    :cond_9
    const/16 v18, 0x0
    ...
    .line 1192
    .restart local v18    # "includeTag":Z
    ...
    invoke-virtual {v2, v0, v15}, Lcom/android/server/net/NetworkStatsRecorder;->dumpLocked(Lcom/android/internal/util/IndentingPrintWriter;Z)V
    ...
    .line 1259
    .local v24, "reader":Ljava/io/RandomAccessFile;
    :try_start_3
    new-instance v25, Ljava/io/RandomAccessFile;

    const-string v2, "/proc/net/xt_qtaguid/stats_pid"
    ...
    .line 1260
    .end local v24    # "reader":Ljava/io/RandomAccessFile;
    .local v25, "reader":Ljava/io/RandomAccessFile;
    :try_start_4
    invoke-virtual/range {v25 .. v25}, Ljava/io/RandomAccessFile;->readLine()Ljava/lang/String;
    ...
    .end local v25    # "reader":Ljava/io/RandomAccessFile;
    .restart local v24    # "reader":Ljava/io/RandomAccessFile;
    :cond_13
    :goto_a
    :try_start_6
    monitor-exit v26
    ...
    .restart local v25    # "reader":Ljava/io/RandomAccessFile;
    :catch_0
    move-exception v14
