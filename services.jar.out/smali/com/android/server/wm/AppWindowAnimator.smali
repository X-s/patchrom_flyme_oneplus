...
.method public setAnimation(Landroid/view/animation/Animation;IIZI)V
    ...
    const-string/jumbo v8, "Setting animation in "
    ...
    invoke-virtual {v7, v4}, Landroid/view/animation/Transformation;->setAlpha(F)V
    ...
    iget-boolean v4, v4, Lcom/android/server/wm/AppWindowToken;->appFullscreen:Z

    if-nez v4, :cond_4

    .line 157
    invoke-virtual {p1, v6}, Landroid/view/animation/Animation;->setBackgroundColor(I)V
    ...
    const-string/jumbo v4, "plugin.luckymoney.ui.LuckyMoneyReceiveUI"
    ...
    invoke-virtual {v4, v7}, Landroid/view/animation/Animation;->scaleCurrentDuration(F)V
    ...
    const-string/jumbo v8, "Cancel Animation, name = "
    ...
    .line 172
    :cond_6
    iget-boolean v4, p0, Lcom/android/server/wm/AppWindowAnimator;->mClearProlongedAnimation:Z

    if-eqz v4, :cond_9

    .line 173
    iput v6, p0, Lcom/android/server/wm/AppWindowAnimator;->mProlongAnimation:I
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowState;->resetJustMovedInStack()V
    ...
    .line 175
    :cond_9
    iput-boolean v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mClearProlongedAnimation:Z
