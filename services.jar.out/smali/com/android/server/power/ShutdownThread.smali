...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    const v7, #android:style@Theme.DeviceDefault.Dialog.Alert#t
...
.method public run()V
    ...
    .line 472
    const-string/jumbo v28, "/data/mdm/mdm_tmp_log"

    .line 475
    .local v28, "mdmTmpPath":Ljava/lang/String;
    :try_start_0
    ...
    .line 477
    .local v31, "p":Ljava/lang/Process;
    invoke-virtual/range {v31 .. v31}, Ljava/lang/Process;->waitFor()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 484
    .end local v28    # "mdmTmpPath":Ljava/lang/String;
    .end local v31    # "p":Ljava/lang/Process;
    :cond_1
    :goto_2
    const-string/jumbo v2, "ShutdownThread"
    ...
    .line 538
    check-cast v32, Lcom/android/server/pm/PackageManagerService;

    .line 540
    .local v32, "pm":Lcom/android/server/pm/PackageManagerService;
    if-eqz v32, :cond_6

    .line 541
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/pm/PackageManagerService;->shutdown()V
    ...
    .line 560
    :cond_8
    new-instance v30, Lcom/android/server/power/ShutdownThread$4;
    ...
    .line 629
    .local v17, "cryptState":Ljava/lang/String;
    if-eqz v23, :cond_c
    ...
    .end local v17    # "cryptState":Ljava/lang/String;
    .end local v23    # "isAlarmBoot":Z
    .end local v24    # "endShutTime":J
    .end local v26    # "endTime":J
    .end local v30    # "observer":Landroid/os/storage/IMountShutdownObserver;
    .end local v32    # "pm":Lcom/android/server/pm/PackageManagerService;
    ...
    .line 478
    .restart local v28    # "mdmTmpPath":Ljava/lang/String;
    ...
    .restart local v24    # "endShutTime":J
    ...
    .restart local v32    # "pm":Lcom/android/server/pm/PackageManagerService;
    :cond_11
    :try_start_7
    const-string/jumbo v2, "ShutdownThread"
    ...
    .end local v18    # "delay":J
    .end local v22    # "e":Ljava/lang/InterruptedException;
    .restart local v17    # "cryptState":Ljava/lang/String;
