...
.method public constructor <init>(Lcom/android/server/notification/ZenModeHelper;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;->ZEN_MODE_ALARMS_SILENT_MANUAL:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;->ZEN_MODE_ALARMS_PRIORITY_MANUAL:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;->ZEN_MODE_MEDIA_SILENT_MANUAL:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;->ZEN_MODE_MEDIA_PRIORITY_MANUAL:Landroid/net/Uri;
...
.method public update(Landroid/net/Uri;)V
    ...
    invoke-static {v1}, Lcom/android/server/notification/ZenModeHelper;->access$1300(Lcom/android/server/notification/ZenModeHelper;)I

    move-result v1

    # setter for: Lcom/android/server/notification/ZenModeHelper;->mZenMode:I
    invoke-static {v0, v1}, Lcom/android/server/notification/ZenModeHelper;->access$1002(Lcom/android/server/notification/ZenModeHelper;I)I

    .line 798
    :cond_0
    iget-object v0, p0, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;->this$0:Lcom/android/server/notification/ZenModeHelper;

    # invokes: Lcom/android/server/notification/ZenModeHelper;->applyRestrictions()V
    ...
    invoke-static {v0}, Lcom/android/server/notification/ZenModeHelper;->access$1500(Lcom/android/server/notification/ZenModeHelper;)V
