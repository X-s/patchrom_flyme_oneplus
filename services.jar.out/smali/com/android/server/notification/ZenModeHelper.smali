...
.field private mMediaPriority:Z

.field private mMediaSilent:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/notification/ConditionProviders;)V
    ...
    invoke-direct {v0, p0, v3}, Lcom/android/server/notification/ZenModeHelper$RingerModeDelegate;-><init>(Lcom/android/server/notification/ZenModeHelper;Lcom/android/server/notification/ZenModeHelper$1;)V
    ...
    invoke-direct {v0, p0, v3}, Lcom/android/server/notification/ZenModeHelper$Metrics;-><init>(Lcom/android/server/notification/ZenModeHelper;Lcom/android/server/notification/ZenModeHelper$1;)V
    ...
    .line 97
    iput-boolean v1, p0, Lcom/android/server/notification/ZenModeHelper;->mMediaPriority:Z

    .line 98
    iput-boolean v1, p0, Lcom/android/server/notification/ZenModeHelper;->mMediaSilent:Z
    ...
    invoke-direct {v0, p0, p2, v3}, Lcom/android/server/notification/ZenModeHelper$H;-><init>(Lcom/android/server/notification/ZenModeHelper;Landroid/os/Looper;Lcom/android/server/notification/ZenModeHelper$1;)V
...
.method static synthetic access$1000(Lcom/android/server/notification/ZenModeHelper;)I
    .locals 1
...
.method static synthetic access$1002(Lcom/android/server/notification/ZenModeHelper;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
    .param p1, "x1"    # I
...
.method static synthetic access$1100(Lcom/android/server/notification/ZenModeHelper;Ljava/lang/Integer;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$1200(Lcom/android/server/notification/ZenModeHelper;ILandroid/net/Uri;Ljava/lang/String;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
    .param p1, "x1"    # I
...
.method static synthetic access$1300(Lcom/android/server/notification/ZenModeHelper;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$1600(Lcom/android/server/notification/ZenModeHelper;)Lcom/android/server/notification/ZenModeHelper$H;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$900(Lcom/android/server/notification/ZenModeHelper;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method private applyOnePlusZenToRingerMode(I)V
    ...
    const-string v2, "[applyOnePlusZenToRingerMode] audio manager is not initialized"
...
.method private setConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v3, p1, v2, v4}, Lcom/android/server/notification/ZenModeConditions;->evaluateConfig(Landroid/service/notification/ZenModeConfig;ZI)V
...
.method private setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Z)V
    ...
    const-string v10, "setManualZenMode "
    ...
    const-string v10, " setRingerMode="
    ...
    .line 241
    :cond_2
    iget-object v8, p0, Lcom/android/server/notification/ZenModeHelper;->mConfigs:Landroid/util/SparseArray;
    ...
    iput-boolean v8, v1, Landroid/service/notification/ZenModeConfig$ZenRule;->snoozing:Z
    ...
    .line 255
    .local v6, "newRule":Landroid/service/notification/ZenModeConfig$ZenRule;
    const/4 v8, 0x1

    iput-boolean v8, v6, Landroid/service/notification/ZenModeConfig$ZenRule;->enabled:Z

    .line 256
    iput p1, v6, Landroid/service/notification/ZenModeConfig$ZenRule;->zenMode:I

    .line 257
    iput-object p2, v6, Landroid/service/notification/ZenModeConfig$ZenRule;->conditionId:Landroid/net/Uri;

    .line 258
    iput-object v6, v5, Landroid/service/notification/ZenModeConfig;->manualRule:Landroid/service/notification/ZenModeConfig$ZenRule;

    .line 260
    .end local v6    # "newRule":Landroid/service/notification/ZenModeConfig$ZenRule;
    :cond_5
    invoke-direct {p0, v5, p3, p4}, Lcom/android/server/notification/ZenModeHelper;->setConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Z)Z
...
.method public onUserSwitched(I)V
    ...
    const-string v4, "onUserSwitched u="
    ...
    const-string v4, "onUserSwitched: generating default config for user "
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/server/notification/ZenModeHelper;->setConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;)Z
...
.method public setOnePlusVibrateInSilentMode(Z)V
    ...
    const-string v2, "[setOnePlusVibrateInSilentMode] audio manager is not initialized"
