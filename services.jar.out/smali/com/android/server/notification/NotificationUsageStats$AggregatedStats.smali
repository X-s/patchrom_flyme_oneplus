...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-wide v2, p0, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->mCreated:J

    invoke-direct {v0, v2, v3}, Lcom/android/server/notification/RateEstimator;-><init>(J)V
...
.method private toStringWithIndent(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "  numRateViolations="
    ...
    const-string v1, "  numQuotaViolations="
...
.method public dumpJson()Lorg/json/JSONObject;
    ...
    .line 590
    const-string v1, "numQuotaLViolations"
    ...
    .line 591
    const-string v1, "notificationEnqueueRate"

    invoke-virtual {p0}, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->getEnqueueRate()F

    move-result v2

    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->maybePut(Lorg/json/JSONObject;Ljava/lang/String;F)V
...
.method public emit()V
    ...
    .line 478
    const-string v0, "note_over_rate"

    iget v1, p0, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->numRateViolations:I

    iget-object v2, p0, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->mPrevious:Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;

    iget v2, v2, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->numRateViolations:I
    ...
    .line 479
    const-string v0, "note_over_quota"

    iget v1, p0, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->numQuotaViolations:I

    iget-object v2, p0, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->mPrevious:Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;

    iget v2, v2, Lcom/android/server/notification/NotificationUsageStats$AggregatedStats;->numQuotaViolations:I
