...
.field private static final MSG_KEYGUARD_FP_AUTHENTICATED_TIMEOUT:I = 0x11

.field private static final MSG_KEYGUARD_FP_STATE_CHANGE:I = 0x10
...
.field mOpGlobalActions:Lcom/android/server/policy/OpGlobalActions;
...
.method static constructor <clinit>()V
    ...
    .line 180
    sput-boolean v2, Lcom/android/server/policy/PhoneWindowManager;->SHOW_PROCESSES_ON_ALT_MENU:Z
...
.method static synthetic access$1000(Lcom/android/server/policy/PhoneWindowManager;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/policy/PhoneWindowManager;
    .param p1, "x1"    # Z
...
.method static synthetic access$1100(Lcom/android/server/policy/PhoneWindowManager;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/PhoneWindowManager;
...
.method static synthetic access$1400(Lcom/android/server/policy/PhoneWindowManager;JZLjava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/PhoneWindowManager;
    .param p1, "x1"    # J
    .param p3, "x2"    # Z
...
.method private finishScreenTurningOn()V
    ...
    const-string v5, ", mKeyguardDelegate.isShowing()= "
    ...
    const-string v5, ", mKeyguardDelegate.isFingerprintAuthenticating()= "
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIII)Landroid/view/View;
    ...
    .prologue
    .line 2431
    sget-boolean v13, Lcom/android/server/policy/PhoneWindowManager;->SHOW_STARTING_ANIMATIONS:Z
    ...
    sget-boolean v13, Lcom/android/server/policy/PhoneWindowManager;->DEBUG_STARTING_WINDOW:Z

    if-nez v13, :cond_3

    sget-boolean v13, Lcom/android/server/policy/PhoneWindowManager;->DEBUG_ONEPLUS:Z
    ...
    invoke-direct {v11, v2}, Lcom/android/internal/policy/PhoneWindow;-><init>(Landroid/content/Context;)V
    ...
    const-string v14, "Skip addStartingWindow due to disable preview."
    ...
    invoke-virtual {v11, v13}, Lcom/android/internal/policy/PhoneWindow;->setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-boolean v13, v0, Lcom/android/server/policy/PhoneWindowManager;->mKeyguardHidden:Z
    ...
    invoke-virtual {v9, v13}, Landroid/content/res/ThemeController;->getCorrectThemeResource([I)I

    move-result v7

    .line 2524
    .local v7, "resId":I
    invoke-virtual {v11, v7}, Lcom/android/internal/policy/PhoneWindow;->setStatusBarColor(I)V

    .line 2525
    const/4 v13, 0x1

    invoke-virtual {v11, v13, v7}, Lcom/android/internal/policy/PhoneWindow;->setStartupWindowTheme(ZI)V
    ...
    .line 2533
    invoke-virtual {v11}, Lcom/android/internal/policy/PhoneWindow;->isFloating()Z
    ...
    const-string v14, "Skip addStartingWindow due to floating win."
    ...
    :try_start_9
    invoke-virtual {v11, v13, v14}, Lcom/android/internal/policy/PhoneWindow;->setStartupWindowTheme(ZI)V
    :try_end_9
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 7222
    sput-boolean v0, Lcom/android/server/policy/PhoneWindowManager;->SHOW_PROCESSES_ON_ALT_MENU:Z
    ...
    .line 7231
    const-string v1, " mCameraLensCoverState="
    ...
    const-string v1, "mWakeGestureEnabledSetting="
    ...
    .line 7270
    const-string v1, "mDoublePressOnPowerBehavior="
    ...
    .line 7271
    const-string v1, " mTriplePressOnPowerBehavior="
...
.method public getKeyguardFingerprintMode()I
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->getKeyguardFingerprintMode()I
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    :cond_18
    sget-boolean v4, Lcom/android/server/policy/PhoneWindowManager;->SHOW_PROCESSES_ON_ALT_MENU:Z
    ...
    const-string v6, "com.android.server.LoadAverageService"

    move-object/from16 v0, v36

    invoke-virtual {v0, v4, v6}, Landroid/content/Intent;->setClassName(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 2987
    .local v35, "res":Landroid/content/ContentResolver;
    ...
    .end local v35    # "res":Landroid/content/ContentResolver;
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    const-string v22, "android.policy:KEY"
    ...
    .line 5373
    .local v15, "newInteractive":Z
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/policy/PhoneWindowManager;->isKeyguardFingerprintAuthenticating()Z
    ...
    const-string v20, "change interactive to false"
    ...
    invoke-direct {v0, v1, v15, v6}, Lcom/android/server/policy/PhoneWindowManager;->interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V

    goto/16 :goto_8

    .line 5391
    .end local v15    # "newInteractive":Z
    :sswitch_3
    and-int/lit8 v16, v16, -0x2
    ...
    invoke-static {v0, v1, v16}, Lcom/android/server/policy/PhoneWindowManager$FlymeInjector;->interceptFlymeKeyBeforeQueueing(Lcom/android/server/policy/PhoneWindowManager;Landroid/view/KeyEvent;I)I
...
.method public isKeyguardFingerprintAuthenticating()Z
    .locals 1
...
.method showGlobalActionsInternal()V
    ...
    iget-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mOpGlobalActions:Lcom/android/server/policy/OpGlobalActions;

    if-nez v2, :cond_0

    .line 1332
    new-instance v2, Lcom/android/server/policy/OpGlobalActions;
    ...
    invoke-direct {v2, v4, v5}, Lcom/android/server/policy/OpGlobalActions;-><init>(Landroid/content/Context;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V

    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mOpGlobalActions:Lcom/android/server/policy/OpGlobalActions;

    .line 1335
    :cond_0
    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mOpGlobalActions:Lcom/android/server/policy/OpGlobalActions;
    ...
    invoke-virtual {v4, v2, v5}, Lcom/android/server/policy/OpGlobalActions;->showDialog(ZZ)V
...
.method public systemReady()V
    ...
    iget-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mKeyguardFingerprintChanageCallback:Ljava/lang/Runnable;

    invoke-direct {v1, v2, v3}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;-><init>(Landroid/content/Context;Ljava/lang/Runnable;)V
...
.method protected takeScreenshot(Z)V
    ...
    .prologue
    .line 5071
    iget-object v6, p0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotLock:Ljava/lang/Object;
    ...
    const-string v7, "not handle next screenshot before finishing"
    ...
    iget v5, p0, Lcom/android/server/policy/PhoneWindowManager;->mDisplayRotation:I
    ...
    invoke-virtual {v5, v3, v2, v7, v8}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    .line 5145
    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotConnection:Landroid/content/ServiceConnection;
    ...
    iget-object v7, p0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotTimeout:Ljava/lang/Runnable;
    ...
    iget-object v7, p0, Lcom/android/server/policy/PhoneWindowManager;->mProcessCpuTrackerRunnable:Lcom/oem/debug/ProcessCpuTrackerRunnable;
    ...
    .end local v0    # "build_type":Ljava/lang/String;
    .end local v1    # "cn":Landroid/content/ComponentName;
    .end local v2    # "conn":Landroid/content/ServiceConnection;
    .end local v3    # "intent":Landroid/content/Intent;
    .end local v4    # "longshot":Z
    :catchall_0
    move-exception v5
    ...
    .line 5087
    .restart local v0    # "build_type":Ljava/lang/String;
    .restart local v4    # "longshot":Z
    :cond_4
    const/4 v4, 0x1
