...
.method delayThirdPartAlarm(Lcom/android/server/AlarmManagerService$Batch;J)V
    .locals 12
    ...
    .line 1562
    invoke-virtual {p1}, Lcom/android/server/AlarmManagerService$Batch;->size()I
    ...
    .line 1564
    invoke-virtual {p1, v3}, Lcom/android/server/AlarmManagerService$Batch;->get(I)Lcom/android/server/AlarmManagerService$Alarm;

    move-result-object v1

    .line 1565
    .local v1, "alarm":Lcom/android/server/AlarmManagerService$Alarm;
    iget-boolean v5, v1, Lcom/android/server/AlarmManagerService$Alarm;->thirdPart:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/AlarmManagerService;->mInteractive:Z
    ...
    iput-wide v6, p1, Lcom/android/server/AlarmManagerService$Batch;->start:J
    ...
    iput-wide v6, p1, Lcom/android/server/AlarmManagerService$Batch;->end:J
    ...
    .line 1572
    .local v2, "batch1":Lcom/android/server/AlarmManagerService$Batch;
    iget-wide v6, v2, Lcom/android/server/AlarmManagerService$Batch;->start:J

    iget-wide v8, p1, Lcom/android/server/AlarmManagerService$Batch;->start:J
    ...
    .line 1575
    .end local v2    # "batch1":Lcom/android/server/AlarmManagerService$Batch;
    :cond_0
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->mAlarmBatches:Ljava/util/ArrayList;
    ...
    const-string v7, "delay third part wakeup alarm\n   "
    ...
    .restart local v2    # "batch1":Lcom/android/server/AlarmManagerService$Batch;
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/AlarmManagerService;->delayThirdPartAlarm(Lcom/android/server/AlarmManagerService$Batch;J)V
