...
.field private static final MONITORING_CERT_NOTIFICATION_ID:I = 0x10400fb
...
.method private enforceCanSetDeviceOwner()V
    ...
    invoke-virtual {v9}, Lcom/android/server/devicepolicy/DeviceOwner;->hasDeviceOwner()Z
    ...
    const-string v9, "Trying to set the device owner, but device owner is already set."
    ...
    const-string v9, "Not allowed to set the device owner because there are already several users on the device"
    ...
    .line 4703
    .local v7, "mAccounts":[Landroid/accounts/Account;
    array-length v9, v7
    ...
    const-string v9, "Not allowed to set the device owner because there are already some accounts on the device"
    ...
    .restart local v3    # "canAddAccounts":Z
    :goto_2
    goto :goto_0
    ...
    .end local v5    # "i$":I
    .end local v6    # "len$":I
    .end local v7    # "mAccounts":[Landroid/accounts/Account;
    :cond_a
    iget-object v9, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mContext:Landroid/content/Context;

    const-string v10, "android.permission.MANAGE_PROFILE_AND_DEVICE_OWNERS"
    ...
    const-string v9, "Cannot set the device owner if the device is already set-up"
