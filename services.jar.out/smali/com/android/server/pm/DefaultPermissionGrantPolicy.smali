...
.method private grantDefaultSystemHandlerPermissions(I)V
    ...
    .line 281
    .local v81, "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 282
    .local v71, "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 284
    .local v69, "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 285
    .local v76, "syncAdapterPackagesProvider":Landroid/content/pm/PackageManagerInternal$SyncAdapterPackagesProvider;
    monitor-exit v85
    :try_end_0
    ...
    .line 291
    .local v80, "voiceInteractPackageNames":[Ljava/lang/String;
    :goto_1
    if-eqz v55, :cond_d
    ...
    .line 295
    .local v70, "smsAppPackageNames":[Ljava/lang/String;
    :goto_3
    if-eqz v35, :cond_f
    ...
    .line 299
    .local v68, "simCallManagerPackageNames":[Ljava/lang/String;
    :goto_5
    if-eqz v76, :cond_11
    ...
    .line 316
    .local v77, "verifierPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v77, :cond_1
    ...
    .line 325
    .local v64, "setupIntent":Landroid/content/Intent;
    ...
    .line 328
    .local v65, "setupPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v65, :cond_2
    ...
    .line 371
    .local v75, "storagePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v75, :cond_7
    ...
    aget-object v67, v5, v46

    .line 404
    .local v67, "simCallManagerPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 406
    .local v66, "simCallManagerPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v66, :cond_a
    ...
    .end local v64    # "setupIntent":Landroid/content/Intent;
    .end local v65    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .end local v66    # "simCallManagerPackage":Landroid/content/pm/PackageParser$Package;
    .end local v67    # "simCallManagerPackageName":Ljava/lang/String;
    .end local v68    # "simCallManagerPackageNames":[Ljava/lang/String;
    .end local v69    # "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .end local v70    # "smsAppPackageNames":[Ljava/lang/String;
    .end local v71    # "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .end local v75    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .end local v76    # "syncAdapterPackagesProvider":Landroid/content/pm/PackageManagerInternal$SyncAdapterPackagesProvider;
    .end local v77    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    .end local v80    # "voiceInteractPackageNames":[Ljava/lang/String;
    .end local v81    # "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    :catchall_0
    move-exception v84
    ...
    .restart local v69    # "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .restart local v71    # "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .restart local v76    # "syncAdapterPackagesProvider":Landroid/content/pm/PackageManagerInternal$SyncAdapterPackagesProvider;
    .restart local v81    # "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    :cond_b
    const/16 v49, 0x0
    ...
    .line 291
    .restart local v80    # "voiceInteractPackageNames":[Ljava/lang/String;
    :cond_d
    const/16 v54, 0x0
    ...
    .line 295
    .restart local v70    # "smsAppPackageNames":[Ljava/lang/String;
    :cond_f
    const/16 v34, 0x0
    ...
    .line 299
    .restart local v68    # "simCallManagerPackageNames":[Ljava/lang/String;
    :cond_11
    const/16 v28, 0x0
    ...
    .restart local v64    # "setupIntent":Landroid/content/Intent;
    .restart local v65    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .restart local v75    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .restart local v77    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    :cond_13
    ...
    .line 416
    .local v72, "smsIntent":Landroid/content/Intent;
    ...
    .line 419
    .local v73, "smsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v73, :cond_16
    ...
    .line 432
    .end local v72    # "smsIntent":Landroid/content/Intent;
    .end local v73    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    :cond_16
    ...
    aget-object v74, v5, v46

    .line 424
    .local v74, "smsPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 425
    .restart local v73    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v73, :cond_1d
    ...
    .end local v52    # "len$":I
    .end local v73    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    .end local v74    # "smsPackageName":Ljava/lang/String;
    ...
    aget-object v79, v5, v46

    .line 583
    .local v79, "voiceInteractPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 585
    .local v78, "voiceInteractPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v78, :cond_2c
    ...
    .end local v46    # "i$":I
    .end local v52    # "len$":I
    .end local v78    # "voiceInteractPackage":Landroid/content/pm/PackageParser$Package;
    .end local v79    # "voiceInteractPackageName":Ljava/lang/String;
    :cond_2d
    ...
    .line 605
    .local v82, "voiceRecoIntent":Landroid/content/Intent;
    ...
    .line 608
    .local v83, "voiceRecoPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v83, :cond_2e
    ...
    .line 650
    .local v61, "nfcTagIntent":Landroid/content/Intent;
    const-string v84, "vnd.android.cursor.item/ndef_msg"
    ...
    .line 653
    .local v62, "nfcTagPkg":Landroid/content/pm/PackageParser$Package;
    if-eqz v62, :cond_32
    ...
    .end local v61    # "nfcTagIntent":Landroid/content/Intent;
    .end local v62    # "nfcTagPkg":Landroid/content/pm/PackageParser$Package;
    .end local v64    # "setupIntent":Landroid/content/Intent;
    .end local v65    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .end local v75    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .end local v77    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    .end local v82    # "voiceRecoIntent":Landroid/content/Intent;
    .end local v83    # "voiceRecoPackage":Landroid/content/pm/PackageParser$Package;
    :catchall_1
    move-exception v84
