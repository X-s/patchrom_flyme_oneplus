...
.field static final DEBUG_LOAD:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/ShortcutService;->DEBUG:Z

    .line 143
    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/pm/ShortcutService;->DEBUG_LOAD:Z
...
.method private cleanupDanglingBitmapDirectoriesLocked(I)V
    ...
    .prologue
    .line 1212
    sget-boolean v7, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v9, "cleanupDanglingBitmaps: userId="
    ...
    sget-boolean v9, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v11, "cleanupDanglingBitmaps: Found directory="
    ...
    const-string/jumbo v11, "Removing dangling bitmap directory: "
...
.method private cleanupDanglingBitmapFilesLocked(ILcom/android/server/pm/ShortcutUser;Ljava/lang/String;Ljava/io/File;)V
    ...
    .line 1255
    sget-boolean v6, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v8, "Removing dangling bitmap file: "
...
.method private forUpdatedPackages(IJZLjava/util/function/Consumer;)V
    ...
    sget-boolean v3, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v5, "forUpdatedPackages for user "
    ...
    const-string/jumbo v5, ", lastScanTime="
    ...
    const-string/jumbo v5, "Found updated package "
...
.method private handlePackageAdded(Ljava/lang/String;I)V
    ...
    .line 2698
    sget-boolean v1, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v2, "handlePackageAdded: %s user=%d"
...
.method private handlePackageChanged(Ljava/lang/String;I)V
    ...
    const-string/jumbo v2, "handlePackageChanged: %s user=%d"
...
.method private handlePackageDataCleared(Ljava/lang/String;I)V
    ...
    .line 2740
    :cond_0
    invoke-direct {p0, p1, p2, v4}, Lcom/android/server/pm/ShortcutService;->cleanUpPackageForAllLoadedUsers(Ljava/lang/String;IZ)V
...
.method private handlePackageRemoved(Ljava/lang/String;I)V
    ...
    .line 2730
    :cond_0
    invoke-direct {p0, p1, p2, v5}, Lcom/android/server/pm/ShortcutService;->cleanUpPackageForAllLoadedUsers(Ljava/lang/String;IZ)V
...
.method private handlePackageUpdateFinished(Ljava/lang/String;I)V
    ...
    const-string/jumbo v2, "handlePackageUpdateFinished: %s user=%d"
...
.method private loadBaseStateLocked()V
    ...
    sget-boolean v8, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v10, "Loading from "
...
.method private loadUserInternal(ILjava/io/InputStream;Z)Lcom/android/server/pm/ShortcutUser;
    ...
    sget-boolean v6, Lcom/android/server/pm/ShortcutService;->DEBUG_LOAD:Z
    ...
    const-string/jumbo v7, "depth=%d type=%d name=%s"
...
.method private loadUserLocked(I)Lcom/android/server/pm/ShortcutUser;
    ...
    const-string/jumbo v8, "Loading from "
...
.method private rescanUpdatedPackagesLocked(IJZ)V
    ...
    invoke-direct {v5, p0, v9, p1, p4}, Lcom/android/server/pm/ShortcutService$-void_rescanUpdatedPackagesLocked_int_userId_long_lastScanTime_boolean_forceRescan_LambdaImpl0;-><init>(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutUser;IZ)V
...
.method private saveUserLocked(I)V
    ...
    sget-boolean v4, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v6, "Saving to "
...
.method private scheduleSaveInner(I)V
    ...
    const-string/jumbo v2, "Scheduling to save for "
...
.method static shrinkBitmap(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v9, "Icon size %dx%d, no need to shrink"
    ...
    const-string/jumbo v9, "Icon size %dx%d, shrinking to %dx%d"
    ...
    invoke-virtual {v0, p0, v8, v1, v9}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method private unloadUserLocked(I)V
    ...
    const-string/jumbo v2, "unloadUserLocked: user="
...
.method public applyRestore([BI)V
    ...
    const-string/jumbo v5, "Restoring user "
...
.method checkPackageChanges(I)V
    ...
    const-string/jumbo v8, "checkPackageChanges() ownerUserId="
...
.method public getBackupPayload(I)[B
    ...
    const-string/jumbo v5, "Backing up user "
...
.method handleCleanupUser(I)V
    ...
    const-string/jumbo v2, "handleCleanupUser: user="
...
.method handleLocaleChanged()V
    ...
    const-string/jumbo v3, "handleLocaleChanged"
...
.method handleUnlockUser(I)V
    ...
    const-string/jumbo v4, "handleUnlockUser: user="
...
.method hasShortcutHostPermissionInner(Ljava/lang/String;I)Z
    ...
    sget-boolean v13, Lcom/android/server/pm/ShortcutService;->DEBUG:Z
    ...
    const-string/jumbo v16, "Default launcher from PM: "
    ...
    const-string/jumbo v15, "hasShortcutPermissionInner: pkg=%s prio=%d"
    ...
    const-string/jumbo v16, "Detected launcher: "
...
.method public onApplicationActive(Ljava/lang/String;I)V
    ...
    const-string/jumbo v2, "onApplicationActive: package="
...
.method openIconFileForWrite(ILandroid/content/pm/ShortcutInfo;)Lcom/android/server/pm/ShortcutService$FileOutputStreamWithPath;
    ...
    const-string/jumbo v7, "Saving icon to "
...
.method packageShortcutsChanged(Ljava/lang/String;I)V
    ...
    .line 1550
    const-string/jumbo v1, "Shortcut changes: package=%s, user=%d"
...
.method public reportShortcutUsed(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v4, "reportShortcutUsed: Shortcut %s package %s used on user %d"
...
.method saveDirtyInfo()V
    ...
    const-string/jumbo v4, "saveDirtyInfo"
