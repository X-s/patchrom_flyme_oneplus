...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    check-cast v41, Lcom/android/server/pm/PackageManagerService$HandlerParams;

    .line 1253
    .local v41, "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    ...
    .line 1263
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->serviceError()V
    ...
    .line 1281
    .end local v30    # "idx":I
    .end local v41    # "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    :pswitch_2
    sget-boolean v2, Lcom/android/server/pm/PackageManagerService;->DEBUG_INSTALL:Z
    ...
    .line 1292
    .restart local v41    # "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->serviceError()V
    ...
    .line 1301
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->startCopy()Z
    ...
    .line 1393
    .local v40, "packages":[Ljava/lang/String;
    move/from16 v0, v48
    ...
    check-cast v42, Lcom/android/server/pm/PackageSetting;

    .line 1407
    .local v42, "ps":Lcom/android/server/pm/PackageSetting;
    if-eqz v42, :cond_15
    ...
    .end local v42    # "ps":Lcom/android/server/pm/PackageSetting;
    :cond_16
    ...
    .end local v28    # "i":I
    .end local v35    # "n":I
    .end local v40    # "packages":[Ljava/lang/String;
    ...
    check-cast v22, Lcom/android/server/pm/PackageManagerService$PostInstallData;

    .line 1446
    .local v22, "data":Lcom/android/server/pm/PackageManagerService$PostInstallData;
    move-object/from16 v0, p0
    ...
    .line 1571
    .local v27, "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, v45
    ...
    .line 1572
    .local v44, "requestedPerm":Ljava/lang/String;
    invoke-static/range {v44 .. v44}, Landroid/util/Permission;->isCTADefaultGrantedForSDK23(Ljava/lang/String;)Z
    ...
    .line 1579
    .end local v27    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v29    # "i$":Ljava/util/Iterator;
    .end local v44    # "requestedPerm":Ljava/lang/String;
    :catch_0
    move-exception v25
    ...
    .line 1576
    .end local v25    # "e":Ljava/lang/Exception;
    .restart local v27    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v29    # "i$":Ljava/util/Iterator;
    :cond_33
    :try_start_d
    move-object/from16 v0, p0
    ...
    .line 1611
    .end local v22    # "data":Lcom/android/server/pm/PackageManagerService$PostInstallData;
    .end local v23    # "deleteOld":Z
    :pswitch_9
    move-object/from16 v0, p1
    ...
    .line 1612
    .restart local v43    # "reportStatus":Z
    :cond_38
    const/16 v24, 0x0
    ...
    .line 1663
    .local v38, "originUri":Landroid/net/Uri;
    const-string v2, "PackageManager"
    ...
    .line 1692
    .end local v17    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v38    # "originUri":Landroid/net/Uri;
    .end local v47    # "ret":I
    ...
    .line 1711
    .restart local v38    # "originUri":Landroid/net/Uri;
    ...
    invoke-virtual/range {v46 .. v46}, Lcom/android/server/pm/IntentFilterVerificationResponse;->getFailedDomainsString()Ljava/lang/String;
    ...
    .end local v56    # "verificationId":I
    :pswitch_10
    new-instance v21, Lcom/oneplus/config/ConfigGrabber;
    ...
    # getter for: Lcom/android/server/pm/PackageManagerService;->PROCESS_MANAGEMENT_CONFIG_NAME:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/pm/PackageManagerService;->access$2300()Ljava/lang/String;
    ...
    .line 1782
    .local v21, "configGrabber":Lcom/oneplus/config/ConfigGrabber;
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService$PackageHandler;->this$0:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual/range {v21 .. v21}, Lcom/oneplus/config/ConfigGrabber;->grabConfig()Lorg/json/JSONArray;

    move-result-object v3

    # invokes: Lcom/android/server/pm/PackageManagerService;->resolveProcessManagementConfigFromJSON(Lorg/json/JSONArray;)V
    invoke-static {v2, v3}, Lcom/android/server/pm/PackageManagerService;->access$2400(Lcom/android/server/pm/PackageManagerService;Lorg/json/JSONArray;)V
