...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    .line 1421
    .local v44, "res":Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;
    ...
    # getter for: Lcom/android/server/pm/PackageManagerService;->mOemDeviceIdleWhiteList:Ljava/util/List;
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->access$900(Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    .line 1424
    # invokes: Lcom/android/server/pm/PackageManagerService;->addDozeWhiteList(Ljava/lang/String;)V
    invoke-static {v4}, Lcom/android/server/pm/PackageManagerService;->access$1000(Ljava/lang/String;)V
    ...
    invoke-static {v2, v3, v6, v7}, Lcom/android/server/pm/PackageManagerService;->access$1100(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;I[Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/pm/PackageManagerService;->access$1200(Landroid/content/pm/PackageParser$Package;)Z
    ...
    invoke-static/range {v9 .. v14}, Lcom/android/server/pm/PackageManagerService;->access$1300(Lcom/android/server/pm/PackageManagerService;ZZLjava/util/ArrayList;[ILandroid/content/IIntentReceiver;)V
    ...
    invoke-static {v2, v4, v3}, Lcom/android/server/pm/PackageManagerService;->access$1400(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;I)Z
    ...
    const-string v6, "grant all permissions for package "
    ...
    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService$InstallArgs;->user:Landroid/os/UserHandle;
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->grantRequestedRuntimePermissions(Landroid/content/pm/PackageParser$Package;I[Ljava/lang/String;)V
    invoke-static {v3, v6, v7, v2}, Lcom/android/server/pm/PackageManagerService;->access$1100(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;I[Ljava/lang/String;)V
    :try_end_6
    ...
    .line 1537
    .local v26, "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, v44
    ...
    .line 1545
    .end local v26    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v28    # "i$":Ljava/util/Iterator;
    ...
    const-string v3, "error while grant permission"
    ...
    const-string v6, "error while grant all permission for package "
    ...
    .line 1542
    .end local v24    # "e":Ljava/lang/Exception;
    .restart local v26    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v28    # "i$":Ljava/util/Iterator;
    :cond_33
    :try_start_b
    move-object/from16 v0, p0
    ...
    .end local v44    # "res":Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;
    :cond_34
    const-string v2, "PackageManager"
    ...
    .line 1625
    .local v48, "state":Lcom/android/server/pm/PackageVerificationState;
    if-eqz v48, :cond_0
    ...
    .line 1629
    .local v37, "originUri":Landroid/net/Uri;
    const-string v2, "PackageManager"
    ...
    .line 1658
    .end local v17    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v37    # "originUri":Landroid/net/Uri;
    .end local v46    # "ret":I
    .end local v48    # "state":Lcom/android/server/pm/PackageVerificationState;
    ...
    .line 1661
    .restart local v48    # "state":Lcom/android/server/pm/PackageVerificationState;
    if-nez v48, :cond_3b
    ...
    check-cast v45, Lcom/android/server/pm/PackageVerificationResponse;

    .line 1668
    .local v45, "response":Lcom/android/server/pm/PackageVerificationResponse;
    ...
    .line 1677
    .restart local v37    # "originUri":Landroid/net/Uri;
    ...
    .end local v17    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v37    # "originUri":Landroid/net/Uri;
    .end local v45    # "response":Lcom/android/server/pm/PackageVerificationResponse;
    .end local v46    # "ret":I
    .end local v48    # "state":Lcom/android/server/pm/PackageVerificationState;
    .end local v55    # "verificationId":I
    :pswitch_e
    ...
    check-cast v48, Lcom/android/server/pm/IntentFilterVerificationState;

    .line 1708
    .local v48, "state":Lcom/android/server/pm/IntentFilterVerificationState;
    if-nez v48, :cond_3d
    ...
    .line 1714
    :cond_3d
    invoke-virtual/range {v48 .. v48}, Lcom/android/server/pm/IntentFilterVerificationState;->getUserId()I
    ...
    .line 1736
    :cond_40
    invoke-virtual/range {v48 .. v48}, Lcom/android/server/pm/IntentFilterVerificationState;->isVerificationComplete()Z
