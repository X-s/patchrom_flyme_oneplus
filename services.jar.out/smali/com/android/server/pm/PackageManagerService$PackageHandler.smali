...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    .line 1297
    .local v38, "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    ...
    .line 1333
    .end local v31    # "idx":I
    .end local v38    # "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    :pswitch_2
    sget-boolean v4, Lcom/android/server/pm/PackageManagerService;->DEBUG_INSTALL:Z
    ...
    .local v40, "params$iterator":Ljava/util/Iterator;
    ...
    .line 1346
    .restart local v38    # "params":Lcom/android/server/pm/PackageManagerService$HandlerParams;
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->serviceError()V
    ...
    .line 1357
    .end local v40    # "params$iterator":Ljava/util/Iterator;
    :cond_9
    const-string/jumbo v4, "PackageManager"
    ...
    .line 1382
    .local v51, "ubmsg":Landroid/os/Message;
    ...
    .line 1393
    .end local v51    # "ubmsg":Landroid/os/Message;
    :cond_c
    :goto_1
    const-wide/32 v12, 0x40000
    ...
    .restart local v40    # "params$iterator":Ljava/util/Iterator;
    :goto_2
    invoke-interface/range {v40 .. v40}, Ljava/util/Iterator;->hasNext()Z
    ...
    .line 1462
    .local v37, "packages":[Ljava/lang/String;
    move/from16 v0, v48
    ...
    .line 1471
    .local v32, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;>;"
    :goto_4
    ...
    .line 1482
    .end local v32    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;>;"
    .end local v36    # "packageUserId":I
    :cond_1a
    move/from16 v48, v30
    ...
    aget-object v12, v22, v30

    aget v13, v52, v30

    const/4 v14, 0x1

    invoke-static {v4, v10, v14, v12, v13}, Lcom/android/server/pm/PackageManagerService;->-wrap42(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ZLjava/util/ArrayList;I)V
    ...
    .end local v30    # "i":I
    .end local v33    # "n":I
    .end local v37    # "packages":[Ljava/lang/String;
    .end local v52    # "uids":[I
    :catchall_0
    move-exception v4
    ...
    .restart local v37    # "packages":[Ljava/lang/String;
    .restart local v52    # "uids":[I
    :cond_1b
    const/16 v4, 0xa
    ...
    .line 1554
    .local v29, "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    iget-object v4, v5, Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;->pkg:Landroid/content/pm/PackageParser$Package;
    ...
    .local v44, "requestedPerm$iterator":Ljava/util/Iterator;
    :cond_28
    :goto_10
    ...
    .line 1555
    .local v43, "requestedPerm":Ljava/lang/String;
    invoke-static/range {v43 .. v43}, Landroid/util/Permission;->isCTADefaultGrantedForSDK23(Ljava/lang/String;)Z
    ...
    .line 1562
    .end local v29    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v35    # "packageName":Ljava/lang/String;
    .end local v43    # "requestedPerm":Ljava/lang/String;
    .end local v44    # "requestedPerm$iterator":Ljava/util/Iterator;
    :catch_0
    move-exception v27
    ...
    const-string/jumbo v10, "error while grant permission"
    ...
    .restart local v29    # "grantList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v35    # "packageName":Ljava/lang/String;
    .restart local v44    # "requestedPerm$iterator":Ljava/util/Iterator;
    :cond_29
    :try_start_6
    move-object/from16 v0, p0
    ...
    iget-object v13, v5, Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;->newUsers:[I
    ...
    .line 1559
    invoke-static {v10, v12, v13, v4}, Lcom/android/server/pm/PackageManagerService;->-wrap25(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;[I[Ljava/lang/String;)V
    :try_end_6
    ...
    invoke-static {v4, v0}, Lcom/android/server/pm/PackageManagerService;->-wrap43(Lcom/android/server/pm/PackageManagerService;Ljava/util/Set;)V
    ...
    .local v55, "userId$iterator":Ljava/util/Iterator;
    :goto_13
    ...
    .line 1616
    .end local v54    # "userId":I
    .end local v55    # "userId$iterator":Ljava/util/Iterator;
    :catchall_3
    move-exception v4
    ...
    .line 1621
    .restart local v55    # "userId$iterator":Ljava/util/Iterator;
    :cond_2f
    :try_start_a
    move-object/from16 v0, p0
    ...
    .line 1641
    .local v34, "originUri":Landroid/net/Uri;
    const-string/jumbo v4, "PackageManager"
    ...
    .line 1673
    .end local v19    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v34    # "originUri":Landroid/net/Uri;
    .end local v47    # "ret":I
    .end local v50    # "state":Lcom/android/server/pm/PackageVerificationState;
    .end local v57    # "verificationId":I
    :pswitch_e
    move-object/from16 v0, p1
    ...
    .line 1675
    .restart local v57    # "verificationId":I
    move-object/from16 v0, p0
    ...
    .line 1692
    .restart local v34    # "originUri":Landroid/net/Uri;
    ...
    .line 1716
    invoke-static {v4, v10, v12, v13, v14}, Lcom/android/server/pm/PackageManagerService;->-wrap47(Lcom/android/server/pm/PackageManagerService;IIZLandroid/content/pm/PackageParser$Package;)V
    ...
    const-string/jumbo v12, "Processing IntentFilter verification with token:"
    ...
    .line 1735
    const-string/jumbo v12, " and userId:"
    ...
    check-cast v45, Lcom/android/server/pm/IntentFilterVerificationResponse;

    .line 1740
    .local v45, "response":Lcom/android/server/pm/IntentFilterVerificationResponse;
    ...
    const-string/jumbo v12, "IntentFilter verification with token:"
    ...
    .line 1745
    const-string/jumbo v12, " is settings verifier response with response code:"
    ...
    iget v12, v0, Lcom/android/server/pm/IntentFilterVerificationResponse;->code:I
    ...
    const-string/jumbo v12, "Domains failing verification: "
    ...
    .line 1750
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/pm/IntentFilterVerificationResponse;->getFailedDomainsString()Ljava/lang/String;
    ...
    .line 1758
    const-string/jumbo v12, " was not said to be complete"
    ...
    .line 1766
    .end local v45    # "response":Lcom/android/server/pm/IntentFilterVerificationResponse;
    .end local v49    # "state":Lcom/android/server/pm/IntentFilterVerificationState;
    .end local v54    # "userId":I
    .end local v57    # "verificationId":I
    :pswitch_11
    new-instance v23, Lcom/oneplus/config/ConfigGrabber;
    ...
    invoke-static {}, Lcom/android/server/pm/PackageManagerService;->-get1()Ljava/lang/String;

    move-result-object v10

    move-object/from16 v0, v23

    invoke-direct {v0, v4, v10}, Lcom/oneplus/config/ConfigGrabber;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 1767
    .local v23, "configGrabber":Lcom/oneplus/config/ConfigGrabber;
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/pm/PackageManagerService$PackageHandler;->this$0:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual/range {v23 .. v23}, Lcom/oneplus/config/ConfigGrabber;->grabConfig()Lorg/json/JSONArray;

    move-result-object v10

    invoke-static {v4, v10}, Lcom/android/server/pm/PackageManagerService;->-wrap39(Lcom/android/server/pm/PackageManagerService;Lorg/json/JSONArray;)V
