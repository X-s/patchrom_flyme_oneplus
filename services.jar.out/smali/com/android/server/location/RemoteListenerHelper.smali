...
.method public addListener(Landroid/os/IInterface;)Z
    ...
    .line 62
    const-string v7, "Attempted to register a \'null\' listener."
    ...
    :try_start_1
    invoke-interface {v0, v1, v8}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_1
    ...
    invoke-static {v4, v6, v8}, Lcom/android/server/LocationManagerService;->updateLocationReceiver(IZZ)V
    ...
    const-string v8, "Remote listener already died."

    invoke-static {v5, v8, v2}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
