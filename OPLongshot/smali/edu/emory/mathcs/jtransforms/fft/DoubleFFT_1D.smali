...
.method public constructor <init>(I)V
    ...
    const-string v2, "n must be greater than 0"
...
.method private bluesteini()V
    ...
    iget v4, v0, Ledu/emory/mathcs/jtransforms/fft/DoubleFFT_1D;->nBluestein:I
...
.method private static getReminder(I[I)I
    ...
    const-string v4, "n must be positive integer"
...
.method private makewt(I)V
    ...
    .line 971
    .local v15, "nwh":I
    const-wide v26, 0x3fe921fb54442d18L    # 0.7853981633974483
...
.method radb3(II[DI[DII)V
    ...
    aget-wide v72, p3, v69

    mul-double v58, v70, v72
    ...
    .line 2073
    .local v6, "cr2":D
    const-wide v70, 0x3ffbb67ae8584cabL    # 1.7320508075688774

    aget-wide v72, p3, v43

    mul-double v4, v70, v72
    ...
    .line 2109
    .local v2, "ci2":D
    const-wide v70, 0x3febb67ae8584cabL    # 0.8660254037844387

    sub-double v72, v24, v28
...
.method radb4(II[DI[DII)V
    ...
    const-wide v92, 0x3ff6a09e667f3bcdL    # 1.4142135623730951

    sub-double v94, v68, v60
    ...
    const-wide v92, -0x40095f619980c433L    # -1.4142135623730951

    add-double v94, v68, v60
...
.method radb5(II[DI[DII)V
    ...
    .line 2592
    .local v38, "i1r":D
    const-wide/high16 v130, 0x4000000000000000L    # 2.0

    add-int v132, p4, v65

    aget-wide v132, p3, v132

    mul-double v96, v130, v132
    ...
    mul-double v94, v130, v132

    .line 2594
    .local v94, "ti4":D
    const-wide/high16 v130, 0x4000000000000000L    # 2.0

    add-int v132, v59, v64

    aget-wide v132, p3, v132

    mul-double v102, v130, v132

    .line 2595
    .local v102, "tr2":D
    const-wide/high16 v130, 0x4000000000000000L    # 2.0

    add-int v132, v59, v66

    aget-wide v132, p3, v132

    mul-double v104, v130, v132
...
.method radbg(IIII[DI[DII)V
    ...
    .line 3001
    .local v64, "iw1":I
    const-wide v82, 0x401921fb54442d18L    # 6.283185307179586
    ...
    .line 3132
    .restart local v67    # "jc":I
    mul-double v82, v28, v22

    mul-double v84, v32, v16

    sub-double v24, v82, v84

    .line 3133
    .local v24, "ar2h":D
    mul-double v82, v28, v16

    mul-double v84, v32, v22
...
.method radf4(II[DI[DII)V
    ...
    const-wide v90, -0x40195f619980c433L    # -0.7071067811865476

    add-double v92, v22, v30

    mul-double v58, v90, v92

    .line 2265
    .restart local v58    # "ti1":D
    const-wide v90, 0x3fe6a09e667f3bcdL    # 0.7071067811865476

    sub-double v92, v22, v30

    mul-double v66, v90, v92
...
.method radfg(IIII[DI[DII)V
    ...
    .line 2710
    .local v50, "iw1":I
    const-wide v72, 0x401921fb54442d18L    # 6.283185307179586
    ...
    .line 2872
    .restart local v53    # "jc":I
    mul-double v72, v20, v14

    mul-double v74, v24, v8

    sub-double v16, v72, v74

    .line 2873
    .local v16, "ar2h":D
    mul-double v72, v20, v8

    mul-double v74, v24, v14
...
.method public realForwardFull([DI)V
    ...
    .line 367
    .local v9, "twon":I
    sget-object v4, Ledu/emory/mathcs/jtransforms/fft/DoubleFFT_1D$18;->$SwitchMap$edu$emory$mathcs$jtransforms$fft$DoubleFFT_1D$Plans:[I
...
.method public realInverse([DIZ)V
    ...
    .line 500
    invoke-direct/range {p0 .. p2}, Ledu/emory/mathcs/jtransforms/fft/DoubleFFT_1D;->cftxc020([DI)V
    ...
    .end local v10    # "tmp":D
    :cond_4
    invoke-virtual/range {p0 .. p2}, Ledu/emory/mathcs/jtransforms/fft/DoubleFFT_1D;->rfftb([DI)V
    ...
    .end local v8    # "k":I
    :pswitch_2
    invoke-direct/range {p0 .. p2}, Ledu/emory/mathcs/jtransforms/fft/DoubleFFT_1D;->bluestein_real_inverse([DI)V
...
.method rfftb([DI)V
    ...
    invoke-static {v7, v2, v0, v1, v5}, Ljava/lang/System;->arraycopy([DI[DII)V
